			...
			<div class="dlu-sec-in">
				<div class="dlu-joi-layout">
					...
					<div class="dlu-joi-panel">
						...
						<p class="dlu-sec-desc">Ask JOI anything about Nexus — books, authors, languages, and learning topics.</p>
						<div class="dlu-joi-box">
							<input type="text" id="dlu-joi-input" inputmode="search" placeholder="Ask JOI about books, authors, or languages…" autocomplete="off" enterkeyhint="search" aria-label="Ask JOI Librarian" />
							<button type="button" id="dlu-joi-go" class="dlu-btn-primary dlu-search-submit">Ask JOI</button>
						</div>
						<div id="dlu-joi-result" class="dlu-joi-result" hidden>
							<div class="dlu-joi-result-bar">
								<span class="dlu-joi-result-label"><?php esc_html_e( 'Chat with JOI', 'dejoiy' ); ?></span>
								<button type="button" class="dlu-joi-close" id="dlu-joi-close" data-dlu-joi-close aria-label="<?php esc_attr_e( 'Close JOI chat', 'dejoiy' ); ?>">
							...
							<div class="dlu-joi-chat" id="dlu-joi-chat" aria-live="polite"></div>
							<div class="dlu-joi-books-wrap" id="dlu-joi-books-wrap" hidden></div>
						</div>
					</div>
				</div>
			</div>
