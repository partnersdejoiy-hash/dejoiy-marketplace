...
<div id="woof-modal-shortcode-generator" _style="display: none;">
	...
	<div class="woof-form-shortcode-generator">
		...
		<?php
			...
			printf( wp_kses_post( __( 'Generate your own custom filter by shortcode %s', 'woocommerce-products-filter' ) ), '<a href="https://products-filter.com/shortcode/woof" target="_blank">[woof]</a>' )
		?>
		</h2>
