...
$wcfm_vacation_mode_msg         = wcfm_get_user_meta($user_id, '_wcfm_vacation_msg', true);
	...
	<div class="wcfm-collapse-content">
		...
		<form id="wcfm_settings_form" class="wcfm">
			...
			<div class="wcfm-tabWrap">
				...
				<div class="wcfm-container wcfm_marketplace_store_settings">
					<div id="wcfm_settings_form_store_expander" class="wcfm-content">
						...
						<div class="wcfm_vendor_settings_heading">
							<h2><?php _e('General Setting', 'wc-frontend-manager'); ?></h2>
						</div>
						<div class="wcfm_clearfix"></div>
						<div class="store_address">
							...
							if (!apply_filters('wcfm_is_allow_store_name', true) || !$WCFMmp->wcfmmp_vendor->is_vendor_sold_by($user_id)) {
								if (isset($settings_fields_general['store_name'])) {
									unset($settings_fields_general['store_name']);
								}
								if (isset($settings_fields_general['store_slug'])) {
									unset($settings_fields_general['store_slug']);
								}
							}
							...
							if (!apply_filters('wcfm_is_allow_store_email', true)) {
								if (isset($settings_fields_general['store_email'])) {
									unset($settings_fields_general['store_email']);
								}
							}

							if (!apply_filters('wcfm_is_allow_store_phone', true)) {
								if (isset($settings_fields_general['phone'])) {
									unset($settings_fields_general['phone']);
								}
							}
						...
						<?php if (apply_filters('wcfm_is_allow_brand_settings', true)) { ?>
							...
							<div class="wcfm_vendor_settings_heading">
								<h2><?php _e('Store Brand Setup', 'wc-frontend-manager'); ?></h2>
							</div>
							<div class="wcfm_clearfix"></div>
							<div class="store_address">
								<?php
								...
								if (!apply_filters('wcfm_is_allow_store_logo', true)) {
									if (isset($settings_fields_general['gravatar'])) {
										unset($settings_fields_general['gravatar']);
									}
								}

								if (!apply_filters('wcfm_is_allow_store_banner', true)) {
									if (isset($settings_fields_general['list_banner_type'])) {
										unset($settings_fields_general['list_banner_type']);
									}
									if (isset($settings_fields_general['list_banner'])) {
										unset($settings_fields_general['list_banner']);
									}
									if (isset($settings_fields_general['list_banner_video'])) {
										unset($settings_fields_general['list_banner_video']);
									}
									if (isset($settings_fields_general['banner_type'])) {
										unset($settings_fields_general['banner_type']);
									}
									if (isset($settings_fields_general['banner'])) {
										unset($settings_fields_general['banner']);
									}
									if (isset($settings_fields_general['banner_video'])) {
										unset($settings_fields_general['banner_video']);
									}
									if (isset($settings_fields_general['banner_slider'])) {
										unset($settings_fields_general['banner_slider']);
									}
									if (isset($settings_fields_general['mobile_banner'])) {
										unset($settings_fields_general['mobile_banner']);
									}
								}
								...
								if (!apply_filters('wcfm_is_allow_store_description', true)) {
									if (isset($settings_fields_general['shop_description'])) {
										unset($settings_fields_general['shop_description']);
									}
								}

								if (!apply_filters('wcfm_is_allow_store_shipping_countries', false)) {
									if (isset($settings_fields_general['shop_shipping_countries'])) {
										unset($settings_fields_general['shop_shipping_countries']);
									}
								}
						...
						<?php if (apply_filters('wcfm_is_allow_store_visibility', true)) { ?>
							<div class="wcfm_vendor_settings_heading">
								<h2><?php _e('Store Visibility Setup', 'wc-frontend-manager'); ?></h2>
							</div>
							<div class="wcfm_clearfix"></div>
							<div class="store_address store_visibility_wrap">
								...
								if (!apply_filters('wcfm_is_allow_show_email', true)) {
									if (isset($settings_fields_visibility['store_hide_email'])) {
										unset($settings_fields_visibility['store_hide_email']);
									}
								}

								if (!apply_filters('wcfm_is_allow_show_phone', true)) {
									if (isset($settings_fields_visibility['store_hide_phone'])) {
										unset($settings_fields_visibility['store_hide_phone']);
									}
								}

								if (!apply_filters('wcfm_is_allow_show_address', true)) {
									if (isset($settings_fields_visibility['store_hide_address'])) {
										unset($settings_fields_visibility['store_hide_address']);
									}
								}

								if (!apply_filters('wcfm_is_allow_show_map', true)) {
									if (isset($settings_fields_visibility['store_hide_map'])) {
										unset($settings_fields_visibility['store_hide_map']);
									}
								}

								if (!apply_filters('wcfm_is_allow_store_description', true)) {
									if (isset($settings_fields_visibility['store_hide_description'])) {
										unset($settings_fields_visibility['store_hide_description']);
									}
								}
								...
								if (!apply_filters('wcfm_is_pref_policies', true) || !apply_filters('wcfm_is_allow_store_policy', true) || !apply_filters('wcfm_is_allow_policy_settings', true) || !apply_filters('wcfm_is_allow_show_policy', true)) {
									if (isset($settings_fields_visibility['store_hide_policy'])) {
										unset($settings_fields_visibility['store_hide_policy']);
									}
								}
				...
				<!-- collapsible -->
				<?php if (apply_filters('wcfm_is_allow_store_address', true) && !apply_filters('wcfm_is_pref_multi_store', true)) { ?>
					...
					<div class="wcfm-container">
						<div id="wcfm_settings_form_payment_expander" class="wcfm-content">
							...
							<?php if (in_array('bank_transfer', array_keys($wcfm_marketplace_withdrwal_payment_methods))) { ?>
								<div class="wcfm_clearfix"></div>
								<div class="wcfm_vendor_settings_heading wcfm_marketplace_bank paymode_field paymode_bank_transfer">
									<h3><?php _e('Bank Details', 'wc-frontend-manager'); ?></h3>
								</div>
								<div class="store_address">
									<?php
							...
							<?php if (array_key_exists('stripe', $wcfm_marketplace_withdrwal_payment_methods) && apply_filters('wcfm_is_allow_billing_stripe', true)) { ?>
								<?php if (apply_filters('wcfm_is_allow_stripe_accounts_api', true)) {
									if (!wp_style_is('wcfm_stripe_css', 'enqueued')) {
										wp_enqueue_style('wcfm_stripe_css',  $WCFM->library->css_lib_url . 'wcfm-style-stripe.css', array(), $WCFM->version);
									}
									...
									if ($client_id && $secret_key) {
										...
										$stripe_action = isset($_GET['stripe_action']) ? wc_clean($_GET['stripe_action']) : '';
	
										if (in_array($stripe_action, ['connect', 'refresh', 'disconnect'])) {
											$stripe_client->verify_stripe_credentials();
										}
	
										if ($stripe_action == 'connect' || $stripe_action == 'refresh') {
										...
										if ($stripe_action == 'disconnect') {
											$stripe_user_id = get_user_meta($user_id, 'stripe_user_id', true);
											if (!empty($stripe_user_id)) {
												$stripe_client->delete_account($stripe_user_id);
											}
										}
	
										if ($stripe_client->is_connected_to_stripe()) {
											$message = __('You are connected with stripe.', 'wc-frontend-manager');
											$url = add_query_arg('stripe_action', 'disconnect', get_wcfm_settings_url());
											$btn_text = __('Disconnect Stripe Account', 'wc-frontend-manager');
									...
									if (!$stripe_error) {
										...
										?>
										<div class="paymode_field paymode_stripe">
											<?php _e('Stripe not setup properly, please contact your site admin.', 'wc-frontend-manager'); ?>
										</div>
										<?php
									}
								} else { ?>
