...
class Image_Comparison extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
        return array_merge(['imagesloaded'], apply_filters('etheme_elementor_widget_script_depends', [ 'etheme_image_comparison' ]));
	}
	...
	public function get_style_depends() {
		return apply_filters('etheme_elementor_widget_style_depends', [ 'etheme-elementor-image-comparison' ]);
	}
