...
class WCFM_Integrations_Products_Manage_Controller {
	...
	function wcfm_wc_tiered_price_table_product_meta_save($new_product_id, $wcfm_products_manage_form_data) {
		...
		if (isset($wcfm_products_manage_form_data['tiered_pricing_template'])) {
			update_post_meta($new_product_id, '_tiered_pricing_template', $wcfm_products_manage_form_data['tiered_pricing_template']);
		}
	}
