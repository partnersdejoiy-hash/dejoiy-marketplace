...
$products_type = !$is_fse ? get_option('et_wc_account_products_type', 'random') : 'none';

$endpoints = wc_get_account_menu_items();

$btn_classes = 'btn black big';
if ( $is_fse ) {
    $btn_classes = 'wp-element-button wp-block-button__link has-et-fse-dark-background-color has-et-fse-white-color';
}
...
?>
	...
	<div class="MyAccount-dashboard-buttons"><?php if ( isset($endpoints['orders']) ) : ?>
		    <a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) ); ?>" class="<?php echo esc_attr($btn_classes); ?>"><i class="et-icon et_b-icon et-sent"></i><span><?php echo esc_html__('Recent orders', 'xstore'); ?></span></a>
        <?php endif;
	    if ( isset( $endpoints['edit-address'] ) ) : ?>
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address' ) ); ?>" class="<?php echo esc_attr($btn_classes); ?>"><i class="et-icon et_b-icon et-internet"></i><span><?php echo esc_html__('Addresses', 'xstore'); ?></span></a>
	    <?php endif;
	    if ( isset( $endpoints['edit-account'] ) ) : ?>
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account' ) ) ; ?>" class="<?php echo esc_attr($btn_classes); ?>"><i class="et-icon et_b-icon et-user"></i><span><?php echo esc_html__('Account details', 'xstore'); ?></span></a>
        <?php endif; ?></div>
