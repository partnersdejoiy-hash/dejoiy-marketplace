...
//                etheme_enqueue_style( "swatches-style");
    ...
    public function on_sale_filter_template( $settings, $link ) {
        ...
        $toggle_link = ! isset( $_GET['sale_status'] ) ? add_query_arg( 'on_sale', '1', $base_link ) : $base_link;

        $html .= '<a href="'. esc_url( $toggle_link ) .'" data-value="1" class="filter-item">'.esc_html__('Display sale products only', 'xstore-core').'</a>';
        $html .= '</li>';
