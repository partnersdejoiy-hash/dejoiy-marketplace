...
class Menu_Skeleton extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return apply_filters('etheme_elementor_widget_style_depends', ['etheme-elementor-menu']);
    }
...
//
    ...
    public function init_attributes() {
        ...
        if ( isset($settings['wp_menu']) ) {
            $this->add_render_attribute('main-menu', 'aria-label', esc_html__('Menu', 'xstore-core'));
        }
...
//            'dropdown-top' => 'Dropdown 2', // -
    ...
    public function handle_link_on_click_classes( $classes, $item, $args ) {
        if (in_array( 'menu-item-has-children', $classes ) ) {
            ...
            if ( apply_filters('etheme_elementor_menu_item_arrow_click', false) ) {
                $classes[] = 'dropdown-arrow-click';
            }
