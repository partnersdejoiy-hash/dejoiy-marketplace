		...
		$tabs_setting['tabs']['layout'] = array(
			...
			'fields' => array(
				array(
					...
					'type' => 'radio_inline',
					'options'  => array (
						'small' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-small.svg" title="product-small" alt="product-small">',
						'default' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-medium.svg' . '" title="product-medium" alt="product-medium">',
						'xsmall' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-thin.svg' . '" title="product-thin" alt="product-thin">',
						'large' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-large.svg' . '" title="product-large" alt="product-large">',
						'fixed' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-fixed.svg' . '" title="product-fixed" alt="product-fixed">',
						'center' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-center.svg' . '" title="product-center" alt="product-center">',
						'wide' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-wide.svg' . '" title="product-wide" alt="product-wide">',
						'right' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-right.svg' . '" title="product-right" alt="product-right">',
						'booking' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/woocommerce/single-product/Product-booking.svg' . '" title="product-booking" alt="product-booking">',
						'standard' => '<img src="'.ETHEME_CODE_CUSTOMIZER_IMAGES.'/global/layout/inherit.svg" title="inherit" alt="inherit">'
					),
					'default' => 'standard',
...
function etheme_enqueue_select2_scripts() {
	global $post;
...
add_action('admin_enqueue_scripts', 'etheme_enqueue_select2_scripts');

add_action('admin_enqueue_scripts', 'etheme_enqueue_select2_jquery');
function etheme_enqueue_select2_jquery() {
...
function et_cmb2_get_attributes_callback() {
	...
	if (function_exists('wc_get_attribute_taxonomies')){
		foreach (wc_get_attribute_taxonomies() as $attribute) {
			if (apply_filters('xstore_linked_attributes_revert_names', false)) {
