<?php
/**
 * The Template for displaying product popup after ajax adding to cart action .
 *
 * Override this template by copying it to yourtheme/woocommerce/product-added-to-cart.php
 *
