...
//        ));
    ...
    public function get_countdown($product, $product_id) {
        ...
        $end_hour = ( isset( $time_end[0] ) && $time_end[0] != 'Array' && $time_end[0] > 0 ) ? $time_end[0] : '23';
        $end_minute = isset( $time_end[1] ) ? $time_end[1] : '59';
...
//        wp_enqueue_style('etheme-elementor-countdown');
        ...
        $date = strtotime( get_gmt_from_date(date('Y-m-d', $date) . ' '. $end_hour.':'.$end_minute.':59') );
