                        ...
                        <div class="theme-builders-plugin<?php if ( isset($theme_builders_plugin_details['is_free']) ) echo ' is-free'; ?>">
                            ...
                            <div class="theme-builders-plugin-details">
                                ...
                                <?php if (isset($theme_builders_plugin_details['is_free'])) : ?>
                                    <span class="et_plugin-control et-button et-button-sm et-button-green " data-slug="pro-elements" data-action="<?php echo esc_attr($theme_builders_plugin_details['is_installed']) ? 'activate' : 'install'; ?>">
                                        <?php echo esc_attr($theme_builders_plugin_details['is_installed']) ? esc_html__('Activate', 'xstore') : esc_html__('Install', 'xstore'); ?>
