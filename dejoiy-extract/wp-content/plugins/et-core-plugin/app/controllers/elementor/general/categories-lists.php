...
class Categories_lists extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->register_view_more_style_controls();
	}
...
//				'mobile_default' => 2,
    ...
    protected function register_nav_controls() {
        $this->start_controls_section(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .limit-enable .limit-link:not(:last-child)' => 'margin-bottom: calc( 10px + {{SIZE}}{{UNIT}});'
                ],
            ]
        );
    ...
    protected function register_view_more_style_controls() {
        $this->start_controls_section(
