...
<form>
	...
	<p>
		<input id="open_ai" placeholder="<?php echo esc_html__('Enter your API key', 'xstore'); ?>" name="open_ai" type="text" value="<?php echo get_theme_mod('open_ai'); ?>">
        <input class="etheme-network-save et-button no-loader" data-network="open-ai" type="submit" value="<?php echo esc_html__('Save', 'xstore'); ?>">
	</p>
