...
class Top_Bar_Menu extends Base_Controller{
    ...
    public function top_bar_menu( $wp_admin_bar ){
        ...
        $force_hide_main_badges = true;
        $domains_count = $this->domains_count_limit();
        $domains_limit_reached = $domains_count > 3;
        $this->is_admin = is_admin();
        $this->is_woocommerce = class_exists('WooCommerce');
        $this->is_fse = apply_filters('etheme_is_fse_theme', false);
        ...
        if($this->is_theme_active){
            ...
            if (
                ...
                if ( !$force_hide_main_badges )
                $notices['support'] = 1; // force activate to reset counter in category
            }
        } else {
//          $notices['activate'] = 1;
        }
        ...
        $builders_icons = $this->get_theme_builders_menu_icons();

        if(!get_option('etheme_current_version')){
            $wp_admin_bar->add_node( array(
                'parent' => 'et-top-bar-general-menu',
                'id'     => 'et-panel-wizard',
                'title'  => $builders_icons['archive'] . esc_html__( 'Setup Wizard', 'xstore-core' ),
                'href'   => admin_url('admin.php?page=xstore-setup&step=welcome')
            ) );
        }
        ...
        if ( $this->is_theme_active || $allow_full_access ) {
            if ( in_array('customize', $this->settings->show_pages) ) {
                $wp_admin_bar->add_node(array(
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', wp_customize_url(), 'main'),
                ));
                ...
                $wp_admin_bar->add_node(array(
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=general'), 'general'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    'id' => 'et-settings-breadcrumbs',
                    'title' => '<span class="dashicons dashicons-before dashicons-carrot"></span>' . __('Breadcrumbs', 'xstore-core'),
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=breadcrumbs'), 'breadcrumbs'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    'id' => 'et-settings-footer',
                    'title' => '<span class="dashicons dashicons-before dashicons-arrow-down-alt"></span>' . __('Footer', 'xstore-core'),
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=footer'), 'footer', 'footer-layout'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=mobile_panel'), 'mobile_panel'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=style'), 'style'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=typography-content'), 'typography-content'),
                ));
...
//                }
                if ($this->is_woocommerce) {
                    $wp_admin_bar->add_node(array(
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=woocommerce'), 'woocommerce', 'shop-page'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=xstore-wishlist'), 'xstore-wishlist'),
                    ));
                    ...
                    $wp_admin_bar->add_node(array(
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=xstore-compare'), 'xstore-compare'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=shop-elements'), 'shop-elements', 'shop-categories'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        'id' => 'et-settings-cart-page',
                        'title' => '<span class="dashicons dashicons-before dashicons-cart"></span>' . __('Cart Page', 'xstore-core'),
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=cart-page'), 'cart-page', 'cart-cross-sell'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=woocommerce_checkout'), 'woocommerce_checkout'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=cart-checkout-layout'), 'cart-checkout-layout'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=shop-color-swatches'), 'shop-color-swatches'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=shop-quick-view'), 'shop-quick-view'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=shop-brands'), 'shop-brands'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        'id' => 'et-settings-catalog-mode',
                        'title' => '<span class="dashicons dashicons-before dashicons-hidden"></span>' . __('Catalog Mode', 'xstore-core'),
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=catalog-mode'), 'catalog-mode'),
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-theme-settings',
                        ...
                        'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=shop-page-filters'), 'shop-page-filters'),
                    ));
                }
                ...
                $wp_admin_bar->add_node(array(
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=blog'), 'blog', 'blog-blog_page'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    'id' => 'et-settings-portfolio',
                    'title' => '<span class="dashicons dashicons-before dashicons-images-alt2"></span>' . __('Portfolio', 'xstore-core'),
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=portfolio'), 'portfolio'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=social-sharing'), 'social-sharing'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=general-page-not-found'), 'general-page-not-found'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=style-custom_css'), 'style-custom_css', 'global-custom_css'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=title_tagline'), 'title_tagline'),
                ));
//                $wp_admin_bar->add_node(array(
//                    'parent' => 'et-theme-settings',
...
//                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=general-optimization'), 'general-optimization'),
//                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    'id' => 'et-settings-nav_menus',
                    'title' => '<span class="dashicons dashicons-before dashicons-menu"></span>' . __('Menus', 'xstore-core'),
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=nav_menus'), 'nav_menus'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    'id' => 'et-settings-widgets',
                    'title' => '<span class="dashicons dashicons-before dashicons-wordpress-alt"></span>' . __('Widgets', 'xstore-core'),
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[panel]=widgets'), 'widgets'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=static_front_page'), 'static_front_page'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=custom_css'), 'custom_css'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    ...
                    'href' => apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=cei-section'), 'cei-section', 'import_export'),
                ));
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-theme-settings',
                    'id' => 'et-live-theme-settings',
                    'title' => '<span class="dashicons dashicons-before dashicons-admin-customizer"></span>' . __('Live Theme Options', 'xstore-core'),
            ...
            if (in_array('demos', $this->settings->show_pages)) {
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-top-bar-general-menu',
                    'id' => 'et-panel-demos',
                    'title' => $menu_icons['demos'] . esc_html__('Import Demos 150+', 'xstore-core'),
            ...
            if (get_theme_mod('etheme_slides', true) && $this->is_elementor) {
                $wp_admin_bar->add_node(array(
                    ...
                    'title' => $menu_icons['etheme_slides'] . esc_html__('Slides', 'xstore-core'),
            ...
            if (get_theme_mod( 'etheme_mega_menus', true ) && $this->is_elementor) {
                $wp_admin_bar->add_node(array(
                    ...
                    'title' => $menu_icons['etheme_mega_menus'] . esc_html__('Mega Menus', 'xstore-core'),
...
//            if ( !$this->is_theme_active && $allow_full_access ) {
            if ( in_array('welcome', $this->settings->show_pages) ) {
                $notice_icon = !$force_hide_main_badges && (isset($notices['activate']) || isset($notices['licence']) || $domains_limit_reached) ? '<span class="et-title-label'.((isset($notices['activate']) || !$this->is_theme_active || $domains_limit_reached) ? ' et-title-label-error' : '').'">' . (isset($notices['activate']) ? $notices['activate'] : (isset($notices['licence']) ? $notices['licence'] : $domains_limit_reached)) . '</span>' : '';
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-top-bar-general-menu-extra',
                    'id' => 'et-panel-register-license',
                    'title' => $menu_icons['key'] . esc_html__('Theme License', 'xstore-core') . $notice_icon,
                    'href' => admin_url('admin.php?page=et-panel-welcome&section-focus=licence-form'.(!$this->is_theme_active ? '&section-highlighted=1' : '')),
                ));

                if ( $this->is_theme_active ) {
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-panel-register-license',
                        'id' => 'et-panel-license-management',
                        'title' => $menu_icons['customize'] . esc_html__('Manage Active Domains', 'xstore-core'),
                        'href' => 'https://www.8theme.com/account/',
                        'meta' => array(
                            'target' => '_blank'
                        )
                    ));
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-panel-register-license',
                        'id' => 'et-panel-license-terms',
                        'title' => $menu_icons['support'] . esc_html__('License Terms & Conditions', 'xstore-core'),
                        'href' => 'https://themeforest.net/licenses/standard?license=regular',
                        'meta' => array(
                            'target' => '_blank'
                        )
                    ));
                    $wp_admin_bar->add_node(array(
                        ...
                        'title' => '<span class="dashicons dashicons-cart" style="
                            font-family: \'dashicons\';
                            margin-right: 4px;
                            line-height: 1;
                            transform: scale(1.2);
                        "></span>' . esc_html__('Buy Another License', 'xstore-core'),
                    ...
                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-panel-register-license',
                        'id' => 'et-panel-license-activation',
                        'title' => $menu_icons['key'] . esc_html__('Activate Your License', 'xstore-core') . $notice_icon,
                        'href' => admin_url('admin.php?page=et-panel-welcome&section-focus=licence-form&section-highlighted=1')
                    ));

                    $wp_admin_bar->add_node(array(
                        'parent' => 'et-panel-register-license',
                        'id' => 'et-panel-how-to-register-license',
                        'title' => $menu_icons['question_mark'] . sprintf(esc_html__('How to Activate %s', 'xstore-core'), apply_filters('etheme_theme_label', 'XStore')),
                        'href' => 'https://www.8theme.com/documentation/xstore/theme-installation/how-to-registerderegister-xstore-theme-livestaging-websites/',
                        'meta' => array(
                            'target' => '_blank'
                        )
                    ));
                    ...
                    $wp_admin_bar->add_node(array(
                        ...
                        'title' => '<span class="dashicons dashicons-cart" style="
                            ...
                            line-height: 1;
                            transform: scale(1.2);
                        "></span>' . sprintf(esc_html__('Get %s License', 'xstore-core'), apply_filters('etheme_theme_label', 'XStore')),
                        'href' => 'https://1.envato.market/oePdkE',
                        'meta' => array(
                            'target' => '_blank'
                        )
            ...
            if ( isset( $notices['support'] ) ) {
                $notice_icon = isset($notices['support']) ? '<span class="et-title-label et-title-label-error">' . $notices['support'] . '</span>' : '';
                $wp_admin_bar->add_node(array(
                    'parent' => 'et-top-bar-general-menu-extra',
                    'id' => 'et-panel-renew-support',
                    'title' => $menu_icons['support'] . esc_html__('Support Expired', 'xstore-core') . $notice_icon,
                ...
                $wp_admin_bar->add_node(array(
                    ...
                    'title' => $menu_icons['update'] . esc_html__('Renew Support Now', 'xstore-core') . $notice_icon,
                    'href' => 'https://1.envato.market/2rXmmA',
                    'meta' => array(
                        'target' => '_blank'
                    )
        ...
        if ( in_array('system_requirements', $this->settings->show_pages) ) {
            $notice_icon = isset($notices['system_requirements']) ? '<span class="et-title-label et-title-label-error">'.$notices['system_requirements'].'</span>' : '';
            $wp_admin_bar->add_node( array(
                'parent' => 'et-top-bar-general-menu-extra',
        ...
        if ( $update_available ) {
            ...
            $wp_admin_bar->add_node( array(
                ...
                'title'  => $menu_icons['update'] . (!$this->is_theme_active ? esc_html__( 'Auto-Updates', 'xstore-core' ) : esc_html__( 'Theme Update', 'xstore-core' )) . $notice_icon,
        ...
        if (in_array('support', $this->settings->show_pages)) {
            $wp_admin_bar->add_node(array(
                'parent' => 'et-top-bar-general-menu-extra',
                'id' => 'et-panel-support',
                'title' => $menu_icons['support'] . esc_html__('Get Help Now', 'xstore-core'),
                'href' => etheme_support_forum_url(),
                'meta' => array(
                    'target' => '_blank'
                )
            ));
...
//          }
        ...
        if ( ($this->is_theme_active || $allow_full_access) && !$this->settings->hide_theme_builders ) {
            // theme builder
            $this->add_theme_builders_tab($wp_admin_bar, $this->get_theme_builders_menu_icons(), $this->is_woocommerce, $this->is_fse);
        }
        ...
        if ( ($this->is_theme_active || $allow_full_access) && in_array('sales_booster', $this->settings->show_pages) && $this->is_woocommerce ) {
            ...
            $sales_booster_main_features = array(
                ...
                'fake_product_sales' => esc_html__('Item Sold Indicator', 'xstore-core'),
                'customer_reviews_advanced' => esc_html__('Advanced Reviews', 'xstore-core'),
                'quantity_discounts' => esc_html__('Quantity Discounts', 'xstore-core'),
                'safe_checkout' => esc_html__('Safe Checkout', 'xstore-core'),
            );
            $wp_admin_bar->add_node(array(
                'parent' => 'et-top-bar-xstore-sales-booster',
                'id' => 'et-top-bar-xstore-sales-booster-all',
                'title' => esc_html__('All Features', 'xstore-core'),
            ...
            do_action('top_bar_menu_after_xstore_sales_booster', $wp_admin_bar, 'et-top-bar-xstore-sales-booster');
        }
    }

    public function add_theme_builders_tab($wp_admin_bar, $menu_icons, $is_woocommerce, $is_fse)
    {
        ...
        $gutenberg_urls = ['site-editor' => admin_url('site-editor.php') ];
        $gutenberg_urls['pattern'] = add_query_arg( 'p', '/pattern', $gutenberg_urls['site-editor'] );
        $gutenberg_urls['templatePart'] = add_query_arg( 'postType', 'wp_template_part', $gutenberg_urls['pattern'] );
        $gutenberg_urls['template'] = add_query_arg( array('p' => '/template', 'layout' => 'grid'), $gutenberg_urls['site-editor'] );
        $gutenberg_urls['header'] = add_query_arg( 'categoryId', 'header', $gutenberg_urls['templatePart'] );
...
//            'title' => '<span class="ab-label"><img class="et-logo" style="vertical-align: -4px; margin-inline-end: 5px; max-width: 18px;" src="' . $this->settings->title_logo . '" alt="xstore"><span>' . esc_html__('Theme Builders', 'xstore-core') . '</span>',
        ...
        if ( $is_fse ) {
            $theme_builders['header-gutenberg'] = $theme_builders['header'];
        }

        $theme_builders['footer'] = esc_html__('Footer', 'xstore-core');
        if ( $is_fse ) {
            $theme_builders['footer-gutenberg'] = $theme_builders['footer'];
        }
...
//                }
        if ( $is_fse ) {
            $theme_builders['product-gutenberg'] = $theme_builders['product'];
        }
        $theme_builders = array_merge($theme_builders, array(
            'product-archive' => esc_html__('Products Archive', 'xstore-core'),
        ));
        if ( $is_fse ) {
            $theme_builders['product-archive-gutenberg'] = $theme_builders['product-archive'];
        }
//            }
        ...
        if ( $is_fse ) {
            $theme_builders['search-results-gutenberg'] = $theme_builders['search-results'];
        }
...
//            if ( $is_woocommerce ) {
        ...
        if ( $is_fse ) {
            $theme_builders['cart-gutenberg'] = $theme_builders['cart'];
            $theme_builders['checkout-gutenberg'] = $theme_builders['checkout'];
        }
    // }
        ...
        if ( $is_fse ) {
            $theme_builders['archive-gutenberg'] = $theme_builders['archive'];
            $theme_builders['single-post-gutenberg'] = $theme_builders['single-post'];
        }
        ...
        if ( $is_fse ) {
            $theme_builders['error-404-gutenberg'] = $theme_builders['error-404'];
        }
            ...
            foreach ($theme_builders as $theme_builder_unique_key => $theme_builder_unique_name) {
                if ( !$is_woocommerce && in_array($theme_builder_unique_key, array('product','product-old', 'product-archive', 'myaccount', 'cart', 'checkout') ) )
                    ...
                    switch ($theme_builder_unique_key) {
                        ...
                        case 'product-old':
                            ...
                            break;
                        case 'header-gutenberg':
                        case 'footer-gutenberg':
                            $builder_url = add_query_arg( 'categoryId', str_replace('-gutenberg', '', $theme_builder_unique_key), $gutenberg_urls['templatePart'] );
                            break;
                        case 'product-gutenberg':
                        case 'product-archive-gutenberg':
                        case 'search-results-gutenberg':
                        case 'cart-gutenberg':
                        case 'checkout-gutenberg':
                        case 'archive-gutenberg':
                        case 'single-post-gutenberg':
                        case 'error-404-gutenberg':
                            $builder_url = $gutenberg_urls['template'];
                            break;
                    }
                }
                ...
                elseif ( in_array($theme_builder_unique_key, array('header-gutenberg', 'footer-gutenberg', 'product-gutenberg', 'product-archive-gutenberg', 'search-results-gutenberg', 'cart-gutenberg', 'checkout-gutenberg', 'archive-gutenberg', 'single-post-gutenberg', 'error-404-gutenberg')) ) {
                    $parent_node = str_replace('-gutenberg', '', $theme_builder_unique_key);
                    if ( !in_array($theme_builder_unique_key, array('header-gutenberg', 'product-gutenberg' ))) {
                        $local_builder_url = $elementor_builders_url;
                        if ( $this->is_elementor ) {
//                            if ( !($theme_builder_unique_key == 'product-old' && !$is_woocommerce) )
                                $local_builder_url = !$has_pro ? $elementor_builders_url . '&et_trigger_theme_builders_plugins_popup=true' : $elementor_pro_theme_builder_link . '/templates/' . $parent_node;
                        ...
                        $wp_admin_bar->add_node(array(
                            'parent' => 'et-panel-theme-builder-' . $parent_node,
                            'id' => 'et-panel-theme-builder-' . $parent_node . '-elementor',
                            'title' => esc_html__('Via Elementor', 'xstore-core'),
                            'href' => $local_builder_url,
                        ));
                    }
                    $wp_admin_bar->add_node(array(
                        ...
                        'title' => esc_html__('Via Gutenberg', 'xstore-core'),
                        'href' => $builder_url,
                    ));
                }
                else {
...
<path d="M12,0C5.3759766,0,0,5.3759766,0,12s5.3759766,12,12,12s12-5.3759766,12-12S18.6240234,0,12,0z M12,19.2000008
	...
	c3.9719973,0,7.2000008,3.2280025,7.2000008,7.1999998S15.9719973,19.2000008,12,19.2000008z"/>
        ...
        $icons['key'] = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor">
...
<path d="M16 0c-8.84 0-16 7.16-16 16s7.16 16 16 16 16-7.16 16-16-7.16-16-16-16zM21.333 15.267l-5.387 9.080c-0.147 0.24-0.373 0.387-0.613 0.387-0.427 0-0.773-0.413-0.773-0.92v-0.093l0.56-6.267h-2.72c-0.413 0-0.76-0.4-0.76-0.907 0-0.2 0.053-0.387 0.147-0.547l4.76-8.347c0.16-0.24 0.387-0.387 0.627-0.387 0.427 0 0.773 0.413 0.773 0.92v0.107l-0.56 5.52h3.333c0.413 0 0.76 0.413 0.76 0.92 0 0.187-0.053 0.387-0.147 0.533z"></path>
        ...
        $icons['setup_wizard'] = '<span class="dashicons dashicons-admin-tools" style="font-family: dashicons;"></span>';
        return $icons;
    }
...
<path d="M6.19074 12.2571C6.45418 12.2571 6.71004 12.2201 6.95832 12.1461C7.2066 12.0721 7.43874 11.9666 7.65474 11.8295L9.83116 14.0061L10.7185 13.1185L8.54211 10.9421C8.69004 10.7316 8.79825 10.5008 8.86674 10.2497C8.93537 9.99874 8.96968 9.74154 8.96968 9.47811C8.96968 8.72344 8.70351 8.08568 8.17116 7.56484C7.63895 7.04386 6.99284 6.78337 6.23284 6.78337C5.4727 6.78337 4.82653 7.04947 4.29432 7.58168C3.76211 8.11404 3.496 8.76021 3.496 9.52021C3.496 10.2802 3.75642 10.9264 4.27726 11.4587C4.79825 11.9909 5.43607 12.2571 6.19074 12.2571ZM6.23284 10.9939C5.82793 10.9939 5.48105 10.8495 5.19221 10.5606C4.90351 10.2719 4.75916 9.92512 4.75916 9.52021C4.75916 9.1153 4.90351 8.76849 5.19221 8.47979C5.48105 8.19095 5.82793 8.04653 6.23284 8.04653C6.63761 8.04653 6.98442 8.19095 7.27326 8.47979C7.56211 8.76849 7.70653 9.1153 7.70653 9.52021C7.70653 9.92512 7.56211 10.2719 7.27326 10.5606C6.98442 10.8495 6.63761 10.9939 6.23284 10.9939ZM2.02232 16.5C1.59691 16.5 1.23684 16.3526 0.942105 16.0579C0.647368 15.7632 0.5 15.4031 0.5 14.9777V2.02232C0.5 1.59691 0.647368 1.23684 0.942105 0.942105C1.23684 0.647368 1.59691 0.5 2.02232 0.5H8.71053L13.1316 4.92105V14.9777C13.1316 15.4031 12.9842 15.7632 12.6895 16.0579C12.3947 16.3526 12.0347 16.5 11.6093 16.5H2.02232ZM8.07895 5.55263V1.76316H2.02232C1.95747 1.76316 1.89811 1.79017 1.84421 1.84421C1.79018 1.8981 1.76316 1.95747 1.76316 2.02232V14.9777C1.76316 15.0425 1.79018 15.1019 1.84421 15.1558C1.89811 15.2098 1.95747 15.2368 2.02232 15.2368H11.6093C11.6741 15.2368 11.7335 15.2098 11.7874 15.1558C11.8414 15.1019 11.8684 15.0425 11.8684 14.9777V5.55263H8.07895Z" fill="currentColor"></path>
    ...
    public function domains_count_limit() {
        $activated_data = get_option( 'etheme_activated_data' );
        if ( isset($activated_data['domains_count']) )
            return $activated_data['domains_count'];
        return 0;
    }
    ...
    private function style(){
        ...
        #wp-admin-bar-et-top-bar-theme-builders-menu .ab-submenu {
            display: flex;
            flex-wrap: wrap;
        }
        #wp-admin-bar-et-top-bar-theme-builders-menu .ab-submenu li[id*=gutenberg] {
            order: -1;
        }
        #wp-admin-bar-et-top-bar-general-menu li .ab-sub-wrapper .ab-submenu .dashicons:before,
         #wp-admin-bar-et-top-bar-xstore-sales-booster-salesmax .dashicons:before {
            font-size: 14px;
            line-height: 27px;
        }
        ...
        #wp-admin-bar-et-top-bar-general-menu:has(.ab-sub-wrapper .et-title-label-error) > a .et-title-label {
            background: var(--et_admin_red-color, #c62828);
            background: #d63638;
        }
     	...
     	#wp-admin-bar-et-top-bar-general-menu > a .et-title-label {
     	    margin-top: 7px;
     	} 
     	
     	#wp-admin-bar-et-top-bar-general-menu .et-title-label-error {
     	    background: #d63638;
     	}
        /* SalesMax plugin */     	
     	#wp-admin-bar-et-top-bar-xstore-sales-booster #wp-admin-bar-et-top-bar-xstore-sales-booster-salesmax a {
        ...
        #wp-admin-bar-et-top-bar-xstore-sales-booster #wp-admin-bar-et-top-bar-xstore-sales-booster-salesmax a:hover {
            background: #f77f2f;
            box-shadow: none;
        }
