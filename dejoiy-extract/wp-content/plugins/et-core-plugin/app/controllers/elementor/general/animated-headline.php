...
class Animated_Headline extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
        return apply_filters('etheme_elementor_widget_script_depends', ['etheme_waypoints', 'etheme_animated_headline']);
	}
	...
	public function get_style_depends() {
		return apply_filters('etheme_elementor_widget_style_depends', [ 'etheme-elementor-animated-headline' ]);
	}
...
//            'crossthrough' => ['M497.4,23.9C301.6,40,155.9,80.6,4,144.4', 'M14.1,27.6c204.5,20.3,393.8,74,467.3,111.7'],
			...
			'underline' => ['M5.5 125.883C149.207 118.384 329.838 103.383 495.5 125.883'],
		];
