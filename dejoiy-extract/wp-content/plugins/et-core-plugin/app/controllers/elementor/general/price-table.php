...
class Price_Table extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
		return apply_filters('etheme_elementor_widget_style_depends', ['etheme-elementor-price-table']);
	}
...
//				'title_field' => '{{{ item_text }}}',
                'title_field' => '{{{ elementor.helpers.renderIcon( this, selected_item_icon, {}, "i", "panel" ) || \'<i class="{{ item_icon }}" aria-hidden="true"></i>\' }}} <span style="text-transform: capitalize;">{{{ item_text }}}</span>',
            ]
        );
