...
<div class="collapse wcfm-collapse" id="wcfm_payments_listing">
	...
	<div class="wcfm-collapse-content">
					...
					<table id="wcfm-refund-requests" class="display" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th><?php _e( apply_filters( 'wcfm_refund_request_additional_info_column_label', __( 'Additional Info', 'wc-frontend-manager' ) ) ); ?></th>
							</tr>
						</thead>
						<tfoot>
							<tr>
		...
		<?php do_action( 'after_wcfm_refund_requests' ); ?>
	</div>
</div>