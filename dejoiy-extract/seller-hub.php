...
add_filter('admin_url', function($url, $path = '') use ($site_url) { return $site_url . '/wp-admin/' . ltrim($path, '/'); }, 9999, 2);
...
// Dispatch WordPress AJAX requests on sellerhub.dejoiy.com
if (preg_match('#/admin-ajax\.php#', $_SERVER['REQUEST_URI'] ?? '') || (!empty($_REQUEST['action']) && isset($_REQUEST['security']))) {
...
<head>
    ...
    <link rel="stylesheet" href="https://<?php echo $host; ?>/wp-content/plugins/dejoiy-seller-os/assets/css/seller-os.css">
