...
class Etheme_WooCoommerce_Account {
    ...
    public function login_form_action() {
        echo ' action="'.add_query_arg(array('account-active-tab' => 'login'), get_permalink( get_option( 'woocommerce_myaccount_page_id' ) )).'"';
    }

    public function register_form_action() {
        echo ' action="'.add_query_arg(array('account-active-tab' => 'register'), get_permalink( get_option( 'woocommerce_myaccount_page_id' ) )).'"';
    }
