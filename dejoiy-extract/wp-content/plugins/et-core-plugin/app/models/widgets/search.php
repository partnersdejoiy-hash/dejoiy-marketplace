...
class Search extends Widgets {
	...
	function __construct() {
		$widget_ops = array(
			...
			'description' => 'Search form for your site. Additional settings available in Theme Options > Header Builder > Search'
		);
	...
	function widget($args, $instance) {
		...
		?>
			...
			<form role="search" method="get" class="woocommerce-product-search etheme-custom-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                ...
                <?php if ( parent::etheme_should_redirect_to_archive() ) : ?>
