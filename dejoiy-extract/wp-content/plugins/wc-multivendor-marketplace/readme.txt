...
* Fixed - Duplicate product issue on shop page & more offers

= 3.6.6 =
*Updated - 20/02/2024*

* Enhance - WooCommerce 8.6+ compatibility added
* Fixed   - Order details page error when using WooCommerce 8.6+
...
* Fixed   - Yith request a Quote compatibility issue
* Fixed   - Some SQL queries & minor issues fixed
...
* Fixed   - Short code Cross site scripting(XSS) issue fixed
