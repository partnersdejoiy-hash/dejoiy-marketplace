...
class Socials extends Widgets {
    ...
    function widget($args, $instance) {
        ...
        echo $Follow->follow_shortcode(array(
            ...
            'viber' => ( ! empty( $instance['viber'] ) ) ? $instance['viber'] : '',
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance['viber']       = ( ! empty( $new_instance['viber'] ) ) ? strip_tags( $new_instance['viber'] ) : '';
    ...
    function form( $instance ) {
        ...
        parent::widget_input_text( esc_html__( 'Telegram link', 'xstore-core' ), $this->get_field_id( 'telegram' ), $this->get_field_name( 'telegram' ), $telegram );
        ...
        parent::widget_input_text( esc_html__( 'Viber link', 'xstore-core' ), $this->get_field_id( 'viber' ), $this->get_field_name( 'viber' ), $viber );
