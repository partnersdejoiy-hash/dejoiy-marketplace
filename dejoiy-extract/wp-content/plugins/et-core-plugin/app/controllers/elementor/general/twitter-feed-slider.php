...
class Twitter_Feed_Slider extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eight_theme-elementor-icon et-elementor-twitter-slider';
	}
	...
	public function get_style_depends() {
        return array_merge(['e-swiper'], apply_filters('etheme_elementor_widget_style_depends', ['etheme-elementor-twitter-feed']));
	}
	...
	public function render() {
		...
		if ( !$tweets ) return; ?>
            ...
            <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
                ...
                <?php
                if ( !$swiper_latest && 1 < count($tweets) ) {
                    if (in_array($settings['navigation'], array('both', 'arrows')))
                        Elementor::get_slider_navigation($settings, $edit_mode);
                }
                ?>
