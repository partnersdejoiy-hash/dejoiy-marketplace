...
class Product_List extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
		return apply_filters('etheme_elementor_widget_style_depends', [ 'etheme-elementor-product-list' ], true);
	}
    ...
    protected function register_general_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'query_type!' => [ 'current_query', 'best_selling' ],
                ],
            ]
        );
...
//					'description'   =>  esc_html__( 'Enter categories.', 'xstore-core' ),
        ...
        foreach ($product_elements as $key => $value) {
            ...
            switch ($key) {
                ...
                case 'excerpt':
                    ...
                    $selector = '{{WRAPPER}} .etheme-product-list-content .etheme-product-list-title a';
                    if ( $key == 'excerpt' )
                        $selector = '{{WRAPPER}} .etheme-product-list-content .woocommerce-product-details__short-description';
    ...
    protected function register_product_style_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'selector' => '{{WRAPPER}} .etheme-product-list-item, {{WRAPPER}} .etheme-product-has-fadeIn-content:hover .etheme-product-list-spacer',
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .etheme-product-list-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etheme-product-list-categories a' => 'color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function register_image_style_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'image_border',
                'selector' => '{{WRAPPER}} .etheme-product-list-image',
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .etheme-product-list-image, {{WRAPPER}} .etheme-product-list-image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function register_button_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .etheme-product-list-button, {{WRAPPER}} .quantity-wrapper[data-type=advanced] .quantity>span.plus' => 'fill: {{VALUE}}; color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => [ 'classic', 'gradient' ],
                'exclude' => [ 'image' ],
                'selector' => '{{WRAPPER}} .etheme-product-list-button, {{WRAPPER}} .quantity-wrapper[data-type=advanced] .quantity>span.plus',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' 		=> '',
                'selectors' => [
                    '{{WRAPPER}} .etheme-product-list-content > .etheme-product-list-button' => 'width: 100%;',
...
//                $query_args['order']    = 'DESC';
		...
		switch ( $settings['orderby'] ) {
            ...
            case 'modified':
                ...
                break;
			default:
                if ( !in_array($settings['query_type'], array('product_ids', 'current_query', 'best_selling')) )
...
<path d="M0.096 4.656v0.024l1.968 7.824c0 0.264 0.264 0.528 0.528 0.528l14.064 1.92c-0.384 0.504-1.032 0.816-1.704 0.816h-11.184c-0.384 0-0.624 0.264-0.624 0.624s0.264 0.624 0.624 0.624h11.28c1.656 0 3.168-1.248 3.48-2.856l2.328-11.832h2.424c0.384 0 0.624-0.264 0.624-0.624s-0.264-0.624-0.624-0.624h-2.952c-0.24 0-0.624 0.24-0.624 0.528l-0.456 2.424h-18.528c-0.264 0-0.384 0.144-0.504 0.24-0.12 0.12-0.12 0.36-0.12 0.384zM18.984 5.184l-1.704 8.52-14.088-1.824-1.584-6.696h17.376zM12.84 20.328c0 1.464 1.128 2.592 2.592 2.592s2.592-1.128 2.592-2.592c0-1.464-1.128-2.592-2.592-2.592s-2.592 1.128-2.592 2.592zM15.432 19.008c0.696 0 1.32 0.624 1.32 1.32s-0.624 1.32-1.32 1.32-1.32-0.624-1.32-1.32 0.6-1.32 1.32-1.32zM3.024 20.328c0 1.464 1.128 2.592 2.592 2.592s2.592-1.128 2.592-2.592c0-1.464-1.128-2.592-2.592-2.592-1.44 0-2.592 1.128-2.592 2.592zM5.64 19.008c0.696 0 1.32 0.624 1.32 1.32s-0.624 1.32-1.32 1.32-1.32-0.624-1.32-1.32 0.6-1.32 1.32-1.32z"></path>
    ...
    public function get_product_categories() {
        ...
        return !empty($category) ? '<div class="etheme-product-list-categories">' . $category . '</div>' : '';
