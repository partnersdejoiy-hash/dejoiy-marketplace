...
//                    '<a href="' . apply_filters('etheme_theme_options_permalink', admin_url( '/customize.php?autofocus[section]=xstore-wishlist' ), 'xstore-waitlist') . '" target="_blank">' . esc_html__('Waitlist page', 'xstore-core') . '</a>'),
//                'type' => \Elementor\Controls_Manager::SWITCHER,
//            ]
//        );
