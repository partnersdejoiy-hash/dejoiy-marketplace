...
$is_fse_theme = apply_filters('etheme_is_fse_theme', false );
...
$tabs_type = !$is_fse_theme ? etheme_get_option('tabs_type', 'tabs-default') : 'tabs-default';

if ( ( ! empty( $product_tabs ) || $et_tabs['check'] ) && $tabs_type != 'disable' ) : $i=0; ?>
    <?php if (!$is_fse_theme && etheme_get_option( 'single_layout', 'default' ) == 'center' && etheme_get_option('tabs_location', 'after_content') == 'after_content') : ?>
    <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row tabs-full-width">
        ...
        <div class="woocommerce-tabs wc-tabs-wrapper tabs <?php etheme_option('tabs_type'); ?> <?php echo (etheme_get_option('tabs_scroll', 0) && $tabs_type == 'accordion') ? 'tabs-with-scroll' : ''; ?>">
            <ul class="wc-tabs tabs-nav <?php echo true == $is_fse_theme ? ' tabs' : ''; ?>">
                <?php foreach ( $product_tabs as $key => $product_tab ) : $i++; ?>
                    ...
                    <li role="presentation" <?php if($i == 1 && $close_tab) echo 'class="tab_closed"'; ?>>
                        <a href="#tab_<?php echo esc_attr($key) ?>" id="tab_<?php echo esc_attr($key) ?>" role="tab" aria-controls="tab-<?php echo esc_attr( $key ); ?>" class="tab-title <?php if($i == 1 && !$close_tab) echo 'opened'; ?>"><span><?php echo wp_kses_post( apply_filters( 'woocommerce_product_' . $key . '_tab_title', $product_tab['title'], $key ) ); ?></span></a>
                    </li>
                <?php endforeach; ?>
                ...
                <?php if ( $et_tabs['custom_tab1'] && $et_tabs['custom_tab1'] != '' ) : ?>
                    <li role="presentation">
                        <a href="#tab_7" id="tab_7" role="tab" aria-controls="tab-<?php echo esc_attr( $key ); ?>" class="tab-title <?php if( empty( $product_tabs ) && ! empty( $et_tabs['custom_tab1'] ) ) echo 'opened'; ?>"><span><?php echo esc_html($et_tabs['custom_tab1']); ?></span></a>
                    </li>
                <?php endif; ?>

                <?php if ( $et_tabs['custom_tab'] && $et_tabs['custom_tab'] != '' ) : ?>
                    <li role="presentation">
                        <a href="#tab_9" id="tab_9" role="tab" aria-controls="tab-<?php echo esc_attr( $key ); ?>" class="tab-title <?php if( empty( $product_tabs ) && empty( $et_tabs['custom_tab1'] ) && ! empty( $et_tabs['custom_tab'] ) ) echo 'opened'; ?>"><span><?php echo esc_html($et_tabs['custom_tab']); ?></span></a>
                    </li>
                <?php endif; ?>
            </ul>
            ...
            <?php $i = 0; foreach ( $product_tabs as $key => $product_tab ) : $i++; ?>
                ...
                <?php endif; ?>
                <div class="tab-content tab-<?php echo esc_attr($key) ?>" id="content_tab_<?php echo esc_attr($key) ?>" <?php if($i == 1 && !$close_tab) echo 'style="display:block;"'; elseif ( $is_fse_theme ) echo 'style="display:none"'; ?>>
            ...
            <?php if ( $et_tabs['custom_tab1'] && $et_tabs['custom_tab1'] != '' ) : ?>
                ...
                <?php endif; ?>
                <div id="content_tab_7" class="tab-content" <?php if( empty( $product_tabs ) && ! empty( $et_tabs['custom_tab1'] ) ) echo 'style="display:block;"'; elseif ( $is_fse_theme ) echo 'style="display:none"'; ?>>
                    <div class="tab-content-inner">
                        <div class="tab-content-scroll">
                            <?php echo do_shortcode(apply_filters('etheme_single_product_tab_content', etheme_get_custom_field('custom_tab1'), 'custom_tab1')); ?>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( $et_tabs['custom_tab'] && $et_tabs['custom_tab'] != '' ) : ?>
                ...
                <?php endif; ?>
                <div id="content_tab_9" class="tab-content" <?php if( empty( $product_tabs ) && empty( $et_tabs['custom_tab1'] ) && ! empty( $et_tabs['custom_tab'] ) ) echo 'style="display:block;"'; elseif ( $is_fse_theme ) echo 'style="display:none"'; ?>>
                    <div class="tab-content-inner">
                        <div class="tab-content-scroll">
                            <?php echo do_shortcode(apply_filters('etheme_single_product_tab_content', etheme_get_option('custom_tab'), 'custom_tab')); ?>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
