                            ...
                            <div class="media">
                                <?php if ( has_post_thumbnail() && $image ): ?>
                                    <a class="pull-left" href="<?php the_permalink(); ?>">
                                        <?php the_post_thumbnail( apply_filters( 'etheme_widget_post_tabs_thumbnail_size',array(100,100)) ); ?>
                                    </a>
                                 <?php endif ?>
                                <div class="media-body">
                                    <?php echo apply_filters('etheme_widget_post_title', '<h4 class="media-heading"><a href="'.get_the_permalink().'">'.$title.'</a></h4>', $title, get_the_permalink()); ?>
