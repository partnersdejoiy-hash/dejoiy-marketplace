...
<?php if ( $product->is_in_stock() ) : ?>
	...
	<form class="<?php echo apply_filters('etheme_single_product_cart_class','cart'); ?>" method="post" enctype='multipart/form-data' action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>">
	 	<?php
