jQuery(document).ready( function($) {
	const ivole_email_color_options1 = { palettes: ['#2C5E66','#db4437','#0f9d58','#3f51b5','#cddc39','#4285f4'] };
	const ivole_email_color_options2 = { palettes: ['#000000','#2f4f4f','#696969','#c0c0c0','#dcdcdc','#ffffff'] };
	const ivole_email_color_options3 = { palettes: ['#1AB394','#85144b','#001f3f','#0074D9','#111111','#F012BE'] };
