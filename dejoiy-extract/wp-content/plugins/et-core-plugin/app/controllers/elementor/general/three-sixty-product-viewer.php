...
class Three_Sixty_Product_Viewer extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
        return apply_filters('etheme_elementor_widget_script_depends', [ 'etheme_waypoints', 'etheme_three_sixty_product_viewer' ]);
	}
	...
	public function get_style_depends() {
		return apply_filters('etheme_elementor_widget_style_depends', [ 'etheme-elementor-three-sixty-product-viewer' ]);
	}
