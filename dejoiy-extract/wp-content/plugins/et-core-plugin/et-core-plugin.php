...
class ETC_Initial {
	...
	private function define_constants() {
		...
		*/
		 ...
		 * @since 1.5.3
		 */
		define( 'ET_CORE_THEME_MIN_VERSION', '9.7.3' );
	...
	public function requirements_met() {
		...
		// Do it to avoid conflicts with WOODMART theme\plugin
		if (
			defined('WOODMART_CORE_PLUGIN_VERSION')
