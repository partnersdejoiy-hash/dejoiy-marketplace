...
add_filter( $hook, function ( $fields ) use ( $woocommerce_sidebars, $sep_style ) {
    ...
    $args = array(
        ...
        'category_page_columns' => array(
            ...
            'tooltip'     => esc_html__( 'Choose how many products to display per row on product category pages, or select "Inherit" to use the same value as the shop page.', 'xstore' ),
            'section'         => 'shop-page',
            'default'         => 'inherit',
            'choices'         => array(
        ...
        'brand_page_columns' => array(
            ...
            'tooltip'     => esc_html__( 'Choose how many products to display per row on product brand pages, or select "Inherit" to use the same value as the shop page.', 'xstore' ),
            'section'         => 'shop-page',
            'default'         => 'inherit',
            'choices'         => array(
                'inherit' => esc_html__( 'Inherit from shop settings', 'xstore' ),
