    ...
    var GoogleMap = function($scope, $) {
        ...
        function initMap() {
            ...
            $.each(markersLocations, function(index, Element, content) {
                ...
                var icon = '';
                if (Element.pin_icon !== '') {
                    icon = etheme_google_map_loc.plugin_url + 'app/assets/img/marker_'+Element.pin_icon+'.png';
