			...
			<div class="card-flap flap1">
				<div class="card-description">
					<?php if ( isset( $structure['sku'] ) ) : ?>
						<p class="card__text woof_qs_<?php echo esc_attr( $template_result ); ?>_sku" ><?php echo esc_html( $structure['sku']['title'] ); ?>:__SKU__</p>
					<?php endif; ?>
					<?php if ( isset( $structure['key_words'] ) ) : ?>
						<p class="card__text woof_qs_<?php echo esc_attr( $template_result ); ?>_key_words" ><?php echo esc_html( $structure['key_words']['title'] ); ?>:__KEY_WORDS__</p>
					<?php endif; ?>
