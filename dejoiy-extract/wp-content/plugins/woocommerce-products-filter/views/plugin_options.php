		...
		<div class="woof-header">
			<div>
				...
				<?php
					...
					printf( esc_html__( 'Maintained for WooCommerce v.%s.x', 'woocommerce-products-filter' ), esc_html( WOOCOMMERCE_VERSION ) )
				?>
				</i><br />
			</div>
			<div>
				...
				<?php if ( $this->show_notes ) : ?>
					<a href="https://products-filter.com/downloads" target="_blank" class="woof-button"><span class="icon-upload"></span><?php esc_html_e( 'Upgrade', 'woocommerce-products-filter' ); ?></a>
				<?php endif; ?>
			...
			<div class="content-wrap">
					...
					<ul id="woof_options">
						...
						foreach ( $items_order as $key ) {
							...
							if ( in_array( $key, $this->items_keys ) ) {
								woof_print_item_by_key_list( $key, $woof_settings );
							} elseif ( isset( $taxonomies[ $key ] ) ) {
									woof_print_tax_list( $key, $taxonomies[ $key ], $woof_settings );
							}
						}
						?>
					</ul>
				...
				<section id="tabs-3">
							...
							<div class="woof-control">
								...
								<select name="woof_settings[overlay_skin]" class="chosen_select">
									<?php foreach ( $skins as $scheme => $title ) : ?>
										<option value="<?php echo esc_attr( $scheme ); ?>" <?php selected( $skin == $scheme ); ?>><?php echo esc_html( $title ); ?></option>
									<?php endforeach; ?>
								</select>
								...
								<div class="select-wrap">
									<select name="woof_settings[filter_blur]" class="chosen_select">
										<?php foreach ( $use_filter_blur as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $filter_blur == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="select-wrap">
									<select name="woof_settings[save_state_checkbox]" class="chosen_select">
										<?php foreach ( $use_save_states as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $save_state == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="select-wrap">
									<select name="woof_settings[select_design]" class="chosen_select">
										<?php foreach ( $select_designs as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $select_design == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="select-wrap">
									<select name="woof_settings[use_beauty_scroll]" class="chosen_select">
										<?php foreach ( $use_beauty_scroll as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $use_scroll == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="select-wrap">
									<select name="woof_settings[ion_slider_skin]" class="chosen_select">
										<?php foreach ( $skins as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $skin == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="select-wrap">
									<select name="woof_settings[use_tooltip]" class="chosen_select">
										<?php foreach ( $tooltip_selects as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $tooltip_select == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="woof-control">
									...
									<select name="woof_settings[woof_auto_hide_button]" class="chosen_select">
										<?php foreach ( $woof_auto_hide_button as $v => $n ) : ?>
											<option value="<?php echo esc_attr( $v ); ?>" <?php selected( $woof_auto_hide_button_val == $v ); ?>><?php echo esc_html( $n ); ?></option>
										<?php endforeach; ?>
									</select>
								...
								<div class="woof-control">
									...
									<select name="woof_settings[woof_auto_filter_skins]" class="chosen_select">
										<?php foreach ( $woof_auto_filter_skins as $v => $n ) : ?>
											<option value="<?php echo esc_attr( $v ); ?>" <?php selected( $woof_auto_filter_skins_val == $v ); ?>><?php echo esc_html( $n ); ?></option>
										<?php endforeach; ?>
									</select>
					...
					<div class="woof-control-section">
								...
								<div class="select-wrap">
									<select name="woof_settings[toggle_type]" class="chosen_select" id="toggle_type">
										<?php foreach ( $toggle_types as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $toggle_type == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
						...
						<div class="toggle_type_text" 
						<?php
						if ( $toggle_type == 'image' ) :
							?>
							style="display: none;"<?php endif; ?>>
					...
					<div class="woof-control-section">
								...
								<div class="select-wrap">
									<select name="woof_settings[more_less_type]" class="chosen_select" id="more_less_type">
										<?php foreach ( $more_less_types as $key => $value ) : ?>
											<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $more_less_type == $key ); ?>><?php echo esc_html( $value ); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
						...
						<div class="more_less_type_text" 
						<?php
						if ( $more_less_type == 'image' ) :
							?>
							style="display: none;"<?php endif; ?>>
						...
						<div class="more_less_type_image" 
						<?php
						if ( $more_less_type == 'text' ) :
							?>
							style="display: none;"<?php endif; ?>>
							...
							<section id="tabs-41">
								...
								<table class="form-table">
									...
									<tr>
										...
										<td>
											<textarea class="wide woof_custom_css" id="custom_css_code" name="woof_settings[custom_css_code]"><?php echo (isset( $this->settings['custom_css_code'] )? esc_textarea( stripcslashes( $this->settings['custom_css_code'] ) ):'') ?></textarea>
									...
									<tr>
										...
										<td>
											<textarea class="wide woof_custom_css" id="js_after_ajax_done" name="woof_settings[js_after_ajax_done]"><?php echo (isset( $this->settings['js_after_ajax_done'] )?esc_textarea( stripcslashes( esc_js( str_replace( '"', "'", $this->settings['js_after_ajax_done'] ) ) ) ):'') ?></textarea>
														...
														<div class="select-wrap">
															<select name="woof_settings[init_only_on_reverse]">
																<?php foreach ( $init_only_on_r as $key => $value ) : ?>
																	<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['init_only_on_reverse'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
																<?php endforeach; ?>
															</select>
														</div>
										...
										<div class="woof-control">
											...
											<select name="woof_settings[optimize_js_files]">
												<?php foreach ( $optimize_js_files as $key => $value ) : ?>
													<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['optimize_js_files'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
												<?php endforeach; ?>
											</select>
										...
										<div class="woof-control">
											...
											<select name="woof_settings[show_images_by_attr_show]">
												<?php foreach ( $show_images_by_attr as $key => $value ) : ?>
													<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['show_images_by_attr_show'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
												<?php endforeach; ?>
											</select>
											...
											?>
											<div class="select-wrap chosen_select" 
											<?php
											if ( ! $woof_settings['show_images_by_attr_show'] ) :
												?>
												style='display:none;' <?php endif; ?> >
												<select  class="chosen_select" multiple name="woof_settings[show_images_by_attr][]">
													<?php foreach ( $attributes as $attr ) : ?>
														<option value="pa_<?php echo esc_attr( $attr->attribute_name ); ?>" <?php selected( in_array( 'pa_' . $attr->attribute_name, $woof_settings['show_images_by_attr'] ) ); ?>><?php echo esc_html( $attr->attribute_label ); ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										...
										<div class="woof-control">
											...
											<select name="woof_settings[hide_terms_count_txt]">
												<?php foreach ( $hide_terms_count_txt as $key => $value ) : ?>
													<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['hide_terms_count_txt'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
												<?php endforeach; ?>
											</select>
										...
										<div class="woof-control">
											...
											<select name="woof_settings[listen_catalog_visibility]">
												<?php foreach ( $listen_catalog_visibility as $key => $value ) : ?>
													<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['listen_catalog_visibility'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
												<?php endforeach; ?>
											</select>
										...
										<div class="woof-control">
											...
											<select name="woof_settings[disable_swoof_influence]">
												<?php foreach ( $disable_swoof_influence as $key => $value ) : ?>
													<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['disable_swoof_influence'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
												<?php endforeach; ?>
											</select>
										...
										<div class="woof-control">
											...
											<select name="woof_settings[check_really_tax]">
												<?php foreach ( $check_category_page as $key => $value ) : ?>
													<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['check_really_tax'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
												<?php endforeach; ?>
											</select>
									...
									<div class="woof-control-section">
										...
										<div class="woof-control-container">
											<div class="woof-control">
												...
												<select name="woof_settings[cache_count_data]">
													<?php foreach ( $cache_count_data as $key => $value ) : ?>
														<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['cache_count_data'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
													<?php endforeach; ?>
												</select>
											...
											<div class="woof-description">
												...
												// ***
												$sql = 'CREATE TABLE IF NOT EXISTS `' . HUSKY::$query_cache_table . "` (
                                                    `mkey` varchar(64) NOT NULL,
                                                    `mvalue` text NOT NULL,
                                                    PRIMARY KEY `mkey` (`mkey`)
                                                  ) {$charset_collate}";

                                                // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared -- CREATE TABLE with WordPress globals only, no user input.
											...
											<div class="woof-control">
												...
												<select name="woof_settings[cache_terms]">
													<?php foreach ( $cache_terms as $key => $value ) : ?>
														<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['cache_terms'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
													<?php endforeach; ?>
												</select>
											...
											<div class="woof-control">
												...
												<select name="woof_settings[price_transient]">
													<?php foreach ( $price_transient as $key => $value ) : ?>
														<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['price_transient'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
													<?php endforeach; ?>
												</select>
										...
										<div class="woof-control">
											...
											<select id="show_woof_edit_view" name="woof_settings[show_woof_edit_view]">
												<?php foreach ( $show_woof_edit_view as $key => $value ) : ?>
													<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $woof_settings['show_woof_edit_view'] == $key ); ?>><?php echo esc_html( $value ); ?></option>
												<?php endforeach; ?>
											</select>
								...
								<div class="woof-control-section">
									...
									<div class="woof-control-container">
										...
										<div class="woof-description">
											<p class="description">
											<?php
												/* translators: %s: absolute folder path */
												printf( esc_html__( 'Custom extensions folder path relative to: %s', 'woocommerce-products-filter' ), esc_html( WP_CONTENT_DIR ) . esc_html( DIRECTORY_SEPARATOR ) )
											?>
											</p>
										</div>
									</div>
									...
									<?php if ( isset( $this->settings['custom_extensions_path'] ) and ! empty( $this->settings['custom_extensions_path'] ) ) : ?>
										...
										<div class="woof-section-title">
											...
											<div class="col-button">
												...
												if ( $wp_filesystem->is_dir( $this->get_custom_ext_path() ) ) {
													$dir_writable = $wp_filesystem->is_writable( $this->get_custom_ext_path() );
													if ( $dir_writable ) {
														$is_custom_extensions = true;
													}
												} elseif ( ! empty( $this->settings['custom_extensions_path'] ) ) {
												...
												<?php else : ?>
													<span class="woof_orangered">
													<?php
														/* translators: %s: folder path */
														printf( esc_html__( 'Note for admin: Folder %s for extensions is not writable OR doesn exists! Ignore this message if you not planning using HUSKY custom extensions!', 'woocommerce-products-filter' ), esc_html( $this->get_custom_ext_path() ) )
													?>
													</span>
												<?php endif; ?>
											</div>
												...
												<li class="woof_ext_li <?php echo esc_attr( $checked ? 'is_enabled' : 'is_disabled' ); ?>">
													...
													<div class="woof_ext-cell">
														<label for="<?php echo esc_attr( $idx ); ?>">
															<?php if ( ! $is_system ) : ?>
																<input type="checkbox" id="<?php echo esc_attr( $idx ); ?>" 
																<?php
																if ( isset( $info['status'] ) and $info['status'] == 'premium' and $this->show_notes ) :
																	?>
																	disabled="disabled"<?php endif; ?>
																	<?php
																	if ( $checked ) :
																		?>
																	checked=""<?php endif; ?> value="<?php echo esc_attr( $idx ); ?>" name="woof_settings[activated_extensions][]" />
															<?php endif; ?>
															...
															<span class="woof_ext_ver">
																...
																if ( isset( $info['version'] ) ) {
																	/* translators: %s: extension version number */
																	'<i>' . sprintf( esc_html__( 'ver. %s', 'woocommerce-products-filter' ), esc_html( $info['version'] ) ) . '</i>';
																}
															...
															if ( ! empty( $info ) and is_array( $info ) ) {
																...
																<label for="<?php echo esc_attr( $idx ); ?>">
																	<?php if ( ! $is_system ) : ?>
																		<input type="checkbox" id="<?php echo esc_attr( $idx ); ?>" 
																		<?php
																		if ( isset( $info['status'] ) and $info['status'] == 'premium' ) :
																			?>
																			disabled="disabled"<?php endif; ?>
																			<?php
																			if ( $checked ) :
												...
												if ( ! empty( WOOF_EXT::$includes['applications'] ) ) {
													foreach ( WOOF_EXT::$includes['applications'] as $obj ) {
														...
														<li>
															...
															?>
															<a href="#tabs-<?php echo esc_attr( $obj->folder_name ); ?>" title="<?php echo esc_html( $name ); ?>">
				...
				<section id="tabs-7">
					...
					<div class="woof-p-4">
							...
							<div class="woof-d-flex woof-p-4 woof-shadow woof-align-items-center woof-features woof-rounded">
								...
								<div class="woof-ms-4">
									<h5 class="woof-h5 woof-mb-1">
										<a class="woof-text-dark" style="color: #2eca8b" href="https://products-filter.com/shortcode/woof_front_builder/" target="_blank">
										<?php
											/* translators: %s: shortcode example */
											printf( esc_html__( 'The simplest way to create a products filter: drop the shortcode %s wherever you need it (post, text widget, etc.) and configure its options directly on the site frontend. You can also use the basic shortcode [woof].', 'woocommerce-products-filter' ), '[woof_front_builder name="my filter"]' )
										?>
										</a>
									</h5>
								</div>
						...
						<ul class="woof__features-gallery woof__col-6">
							<li><a target="_blank" href="https://products-filter.com/downloads"><img class="woof-rounded" width="300" src="<?php echo esc_url( WOOF_LINK ); ?>/img/plugin_options/banners/woof.png" alt=""></a></li>
							<li><a target="_blank" href="https://bulk-editor.com/downloads"><img class="woof-rounded" width="300" src="<?php echo esc_url( WOOF_LINK ); ?>img/plugin_options/banners/bear.png" alt=""></a></li>
							<li><a target="_blank" href="https://currency-switcher.com/downloads"><img class="woof-rounded" width="300" src="<?php echo esc_url( WOOF_LINK ); ?>img/plugin_options/banners/woot.png" alt=""></a></li>
							<li>
								...
								<div class="woof_option_container woof_option_<?php echo esc_attr( $obj->html_type ); ?>">
									...
									<div class="woof-form-element-container">
										...
										<div class="woof-name-description">
											...
											<span><?php echo esc_html( $option['tip'] ); ?></span>
										</div>
											...
											<div class="select-wrap">
												<select class="woof_popup_option" data-option="<?php echo esc_attr( $key ); ?>">
													<?php foreach ( $option['options'] as $val => $title ) : ?>
														<option value="<?php echo esc_attr( $val ); ?>"><?php echo esc_html( $title ); ?></option>
													<?php endforeach; ?>
												</select>
											</div>
			...
			<tbody>
				<tr>
					<td>
						...
						<a href="https://products-filter.com/downloads" target="_blank"><img src="<?php echo esc_url( WOOF_LINK ); ?>img/plugin_options/banners/woof.png" alt="<?php esc_html_e( 'full version of the plugin', 'woocommerce-products-filter' ); ?>"></a>
					</td>

					<td>
						<h3><?php esc_html_e( 'BEAR - Bulk Editor for WooCommerce', 'woocommerce-products-filter' ); ?>:</h3>
						<a href="https://wordpress.org/plugins/woo-bulk-editor/" target="_blank"><img src="<?php echo esc_url( WOOF_LINK ); ?>img/plugin_options/banners/bear.png" alt="BEAR" /></a>
					</td>

					<td>
						<h3><?php esc_html_e( 'FOX - Currency Switcher for WooCommerce', 'woocommerce-products-filter' ); ?>:</h3>
						<a href="https://wordpress.org/plugins/woocommerce-currency-switcher/" target="_blank"><img src="<?php echo esc_url( WOOF_LINK ); ?>img/plugin_options/banners/woocs.png" alt="FOX" /></a>
					</td>

					<td>
						<h3>Botoscope:</h3>
						<a href="https://wordpress.org/plugins/botoscope/" target="_blank" title="BOTOSCOPE - Bridge your WooCommerce store and Telegram"><img src="<?php echo esc_url( WOOF_LINK ); ?>img/plugin_options/banners/botoscope.png" style="width: 800px;" alt="<?php esc_html_e( 'BOTOSCOPE - Bridge your WooCommerce store and Telegram', 'woocommerce-products-filter' ); ?>" /></a>
					</td>
...
function woof_print_tax_list( $key, $tax, $woof_settings ) {
	?>
	<li data-key="<?php echo esc_attr( $key ); ?>" class="woof_options_li">
					...
					<optgroup label='<?php echo esc_html( $html_types['g_name'] ); ?>'>
						<?php foreach ( $html_types['types'] as $type => $type_text ) : ?>
							...
							if ( isset( $woof_settings['tax_type'][ $key ] ) ) {
								selected( $woof_settings['tax_type'][ $key ], $type );}
							?>
							><?php echo esc_html( $type_text ); ?></option>
						<?php endforeach; ?>
					</optgroup>
				<?php } ?>
			</select>
		...
		<label for="tax_<?php echo esc_attr( md5( $key ) ); ?>"><b><?php echo esc_html( $tax->labels->name ); ?></b></label>
		<?php
		if ( isset( $woof_settings['tax_type'][ $key ] ) ) {
...
function woof_print_item_by_key_list( $key, $woof_settings ) {

	switch ( $key ) {
		case 'by_price':
			if ( ! isset( $woof_settings[ $key ] ) ) {
				$woof_settings[ $key ] = array();
			}
				...
				<div class="select-wrap">
					<select name="woof_settings[<?php echo esc_attr( $key ); ?>][show]" class="woof_setting_select">
						<?php foreach ( woof()->get_price_filter_types() as $val => $title ) : ?>
							<option value="<?php echo intval( $val ); ?>" <?php selected( $show, $val ); ?>><?php echo esc_html( $title ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
