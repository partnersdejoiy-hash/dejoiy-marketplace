...
class Waitlist extends Off_Canvas_Skeleton {
    ...
    public function get_style_depends() {
        return apply_filters('etheme_elementor_widget_style_depends', array_merge(parent::get_style_depends(), [ 'etheme-cart-widget' ]), true);
    }
    ...
    public function get_script_depends() {
        return apply_filters('etheme_elementor_widget_script_depends', parent::get_style_depends(), true);
    }
...
//                    }
    ...
    public function get_icon_qty_count() {
        if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) return '0';
        $extra_args = array();
        if ( get_theme_mod('xstore_waitlist', false) ) {
            ob_start();
