...
$search_radius_range	= isset( $_GET['wcfmmp_radius_range'] ) ? esc_attr($_GET['wcfmmp_radius_range']) : $search_radius_range;
$search_radius_lat 		= isset( $_GET['wcfmmp_radius_lat'] ) ? esc_attr($_GET['wcfmmp_radius_lat']) : $search_radius_lat;
$search_radius_lng 		= isset( $_GET['wcfmmp_radius_lng'] ) ? esc_attr($_GET['wcfmmp_radius_lng']) : $search_radius_lng;
