...
class Etheme_Studio {
	...
	public function enqueue_assets() {
		wp_enqueue_style('etheme-studio-css', ET_CORE_URL.'app/models/studio/css/studio-style.css');
		wp_enqueue_script(
			'etheme-studio-js', ET_CORE_URL . 'app/models/studio/js/studio-script.js',
			array(
				'jquery',
				'elementor-editor',
			),
