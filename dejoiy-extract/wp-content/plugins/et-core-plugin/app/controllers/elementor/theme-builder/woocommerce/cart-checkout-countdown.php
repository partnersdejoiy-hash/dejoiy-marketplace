...
class Cart_Checkout_Countdown extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return apply_filters('etheme_elementor_widget_style_depends', [ 'etheme-sale-booster-cart-checkout-countdown' ], true);
    }
    ...
    public function get_script_depends() {
        return apply_filters('etheme_elementor_widget_script_depends', [ 'cart_checkout_countdown' ], true);
    }
	...
	protected function render() {
        ...
        if ( $is_edit && function_exists( 'WC' ) && property_exists( WC(), 'session' ) && is_object( WC()->session ) )
