...
class Product_Carousel extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
	    return array_merge(['e-swiper'], apply_filters('etheme_elementor_widget_style_depends', []));
	}
	...
	protected function register_controls() {
		...
		$this->register_product_categories_style_controls();
...
//					'light'		=>	esc_html__('Light', 'xstore-core'),
    ...
    protected function register_product_categories_style_controls() {
        $this->start_controls_section(
