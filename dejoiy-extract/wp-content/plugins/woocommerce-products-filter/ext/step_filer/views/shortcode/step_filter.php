...
<div class="woof_step <?php echo esc_attr( $classes ); ?>" data-filter_type="<?php echo esc_attr( $filter_type ); ?>"  data-autosubmit="<?php echo esc_attr( $autosubmit ); ?>" data-hide="<?php echo esc_attr( $autosubmit ); ?>">
	...
	<div class="woof_step_next_back_btn">
		<button  class="button woof_step_filter_prev"><?php echo esc_html( $prev_btn_txt ); ?></button>&nbsp;
		<?php
		if ( $woof_reset_btn_txt != 'none' ) :
			?>
			<button  class="button woof_reset_search_form" data-link="<?php echo esc_url_raw( $woof_link ); ?>"><?php echo esc_html( $woof_reset_btn_txt ); ?></button><?php endif; ?>       
		<button class="button woof_step_filter_next"><?php echo esc_html( $next_btn_txt ); ?></button>
	</div>
	<?php if ( $images ) : ?>
