...
if ( count( $link ) === 1 ) {
	$subscr['link'] .= '?' . esc_html( woof()->get_swoof_search_slug() ) . '=1';
}
...
?>
<?php // Inline styles are required here: this is an HTML email template. Email clients (Gmail, Outlook etc.) do not load external stylesheets. ?>
<style>
	/******************* EMAIL TEMPLATE *********************************/
	.woof_mail{
