...
class Slider extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return apply_filters('etheme_elementor_widget_style_depends', [ 'etheme-et-slider' ]);
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'             => sprintf( esc_html__( 'This widget was deprecated since v4.1.3. Please, use %1s widget instead.', 'xstore-core' ),
                    '<b>'.esc_html__('Slides', 'xstore-core').'</b>'),
