...
<div class="xstore-dashboard-overview xstore-dashboard-widget">
    ...
    <?php if ( in_array('welcome', $white_label_settings->show_pages) ) : ?>
        <div class="xstore-overview__support xstore-dashboard-widget__table-zone">
            ...
            <div class="xstore-overview__create">
                <a href="<?php etheme_support_forum_url(true); ?>" class="button"><?php echo esc_html__('Submit a topic', 'xstore-core'); ?></a>
<!--                <a href="https://1.envato.market/2rXmmA" class="button button-primary">--><?php //echo esc_html__('Renew support', 'xstore-core'); ?><!--</a>-->
    ...
    <?php endif; ?>
    <?php if ( count($recently_edited_ids) ) : ?>
        <div class="xstore-overview__system-req">
            <div class="xstore-overview__title">
            ...
            <ul>
                <?php
                foreach ($recently_edited_ids as $recently_edited_id) {

                    $date = date_i18n( _x( 'M jS', 'Dashboard Overview Widget Recently Date', 'xstore-core' ), get_the_modified_time( 'U', $recently_edited_id ) );
                    ?>
                    <li class="xstore-overview__recent-post">
                        <a href="<?php echo esc_url( get_edit_post_link( $recently_edited_id ) ); ?> "><?php echo get_the_title($recently_edited_id); ?> <span class="dashicons dashicons-edit"></span></a> <span><?php echo esc_html( $date ); ?>, <?php echo get_the_time('', $recently_edited_id); ?></span>
                    </li>
                <?php } ?>
            </ul>
        </div>
    ...
    <?php if ( in_array('sales_booster', $white_label_settings->show_pages) ) : ?>
        <div class="xstore-overview__sales-booster xstore-dashboard-widget__table-zone">
            <div>
                ...
                <p><?php printf(esc_html__('Boosts your eCommerce store\'s conversion rates and success with helpful %1$sfeatures%2$s.', 'xstore-core'), '<a href="'.admin_url( 'admin.php?page=et-panel-sales-booster' ).'">', '</a>'); ?></p>
            </div>
            <div>
