							...
							<div class="select-wrap">
								<select name="woof_settings[woof_turbo_mode][enable]" class="chosen_select">
									<?php foreach ( $enable_turbo as $key => $value ) : ?>
										<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $enable == $key ); ?>><?php echo esc_html( $value ); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
							...
							<div class="select-wrap">
								<select name="woof_settings[woof_turbo_mode][wp_cron_period]" class="chosen_select">
									<?php foreach ( $schedules as $key => $value ) : ?>
										<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $wp_cron_period == $key ); ?>><?php echo esc_html( $value['name'] ); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							...
							<div class="select-wrap">
								<select name="woof_settings[woof_turbo_mode][storing]" class="chosen_select">
									<?php foreach ( $storing as $key => $value ) : ?>
										<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $allow == $key ); ?>><?php echo esc_html( $value ); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
