<?php if(!defined('ABSPATH'))exit; ?>
    ...
    <header id="dcs-mhdr">
      <div id="dcs-mhdr-top">
        ...
        <div class="dcs-micons">
          <a href="https://dejoiy.tech/my-account/" class="dcs-micon" aria-label="Account"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></a>
          ...
          <a href="https://dejoiy.tech/my-account/?et-wishlist-page" class="dcs-micon" aria-label="Wishlist"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></a>
    ...
    <div class="dejoiy-nav-wrapper" id="djNav">
      <div class="dejoiy-nav-scroll" id="djScroll">
        <div class="dejoiy-nav-card dcs-active-card" data-nav="studio" data-href="https://dejoiy.tech/dejoiy-custom-studio/"><div class="dejoiy-nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#E8609A" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l2.09 6.26L20.18 9l-5 4.09L16.82 20 12 16.54 7.18 20l1.64-6.91L3.82 9l6.09-.74z"/></svg></div><span class="dejoiy-nav-label">Custom Studio</span></div>
        <div class="dejoiy-nav-card" data-nav="shop" data-href="https://dejoiy.tech/shop/"><div class="dejoiy-nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#7C5CE4" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg></div><span class="dejoiy-nav-label">Shop</span></div>
        <div class="dejoiy-nav-card" data-nav="library" data-href="https://dejoiy.tech/dejoiy-library/"><div class="dejoiy-nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#A88BF5" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg></div><span class="dejoiy-nav-label">Library</span></div>
        <div class="dejoiy-nav-card" data-nav="quick" data-href="https://dejoiy.tech/shop/"><div class="dejoiy-nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg></div><span class="dejoiy-nav-label">QuickMart</span></div>
        <div class="dejoiy-nav-card" data-nav="refurbished" data-href="https://dejoiy.tech/product-category/renewed-refurbished/"><div class="dejoiy-nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#00C9A7" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg></div><span class="dejoiy-nav-label">Refurbished</span></div>
        <div class="dejoiy-nav-card" data-nav="services" data-href="https://dejoiy.tech/product-category/services-marketplace/"><div class="dejoiy-nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#6366F1" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg></div><span class="dejoiy-nav-label">Services</span></div>
        <div class="dejoiy-nav-card" data-nav="support" data-href="https://dejoiy.tech/support-page/"><div class="dejoiy-nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#EF4444" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg></div><span class="dejoiy-nav-label">Support</span></div>
      </div>
    </div>
    ...
    <nav id="dcs-bnav" aria-label="DEJOIY navigation">
      <a href="https://dejoiy.tech/" class="dcs-bn-item" aria-label="Home">
      ...
      <a href="https://dejoiy.tech/shop/" class="dcs-bn-item" aria-label="Shop">
      ...
      <a href="https://dejoiy.tech/dejoiy-custom-studio/" class="dcs-bn-item dcs-bn-active" aria-label="Studio">
      ...
      <a href="https://dejoiy.tech/dejoiy-library/" class="dcs-bn-item" aria-label="Library">
