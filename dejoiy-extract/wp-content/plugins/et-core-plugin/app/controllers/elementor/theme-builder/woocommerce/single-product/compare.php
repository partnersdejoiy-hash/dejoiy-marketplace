            ...
            $this->add_control(
                ...
                [
                    'raw' => sprintf(esc_html__('To use this widget, please, activate %s option.', 'xstore-core'),
                        '<a href="' . apply_filters('etheme_theme_options_permalink', admin_url( '/customize.php?autofocus[section]=xstore-compare' ), 'xstore-compare') . '" target="_blank">' . esc_html__('Compare', 'xstore-core') . '</a>'),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => sprintf(esc_html__('Enable this option to automatically redirect customers to the compare page when they remove a product from their compare. Note: The compare page can be set in the "%1s" setting.', 'xstore-core'),
                    '<a href="' . apply_filters('etheme_theme_options_permalink', admin_url( '/customize.php?autofocus[section]=xstore-compare' ), 'xstore-compare') . '" target="_blank">' . esc_html__('Compare page', 'xstore-core') . '</a>'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
            ]
        );
	...
	protected function render() {
	    ...
	    if ( !get_theme_mod('xstore_compare', false) || !class_exists('\XStoreCore\Modules\WooCommerce\XStore_Compare' ) ) {
            echo '<div class="elementor-panel-alert elementor-panel-alert-error">' .
                sprintf(esc_html__( 'Please, activate %s option to use this widget.', 'xstore-core' ), '<a href="'.apply_filters('etheme_theme_options_permalink', admin_url( '/customize.php?autofocus[section]=xstore-compare' ), 'xstore-compare').'" target="_blank">'.esc_html__('Compare', 'xstore-core').'</a>') .
                '</div>';
            return;
        }
