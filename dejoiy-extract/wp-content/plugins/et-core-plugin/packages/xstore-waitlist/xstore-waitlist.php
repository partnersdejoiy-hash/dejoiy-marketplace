...
class XStore_Waitlist {
    ...
    public function init() {
        ...
        self::$waitlist_options = array(
            'subscribed_text' => 'This email was already added for notify when this product be in stock',
//            'unsubscribe_error_text'       => esc_html__( 'Your email has not been found in the waiting list for this product. Please, check it and try again or {{join_waitlist_button}}.', 'xstore-core' ),
            'unsubscribe_error_text'       => 'Your email has not been found in the waiting list for this product. Please, check it and try again.',
            'unsubscribe_success_text'       => 'You have been removed from the waiting list for this product!',
            'from_email'         => get_option( 'admin_email' ),
//            'from_name'          => get_option( 'blogname' ),
            'recipient'          => get_option( 'admin_email' ),
            'auto_mail'     => get_theme_mod('xstore_waitlist_customer_email', true),
            'auto_subject'       => 'A product you are waiting for is back in stock!',
            ...
            'auto_footer'        => 'This email does not guarantee the availability of stock. If the item is out of stock again, you will need to re-add yourself to the waitlist.',
            'waitlist_admin_mail'    => true,
            'admin_subject'      => 'You have a new waiting list request on {site_name}',
            ...
            'user_subject'       => 'We have received your waiting list request',
            ...
            'add_intro' => get_theme_mod('xstore_waitlist_popup_intro_add_to_waitlist','This product is currently unavailable'),
            'add_placeholder' => 'Your email address...',
            'add_button_text' => get_theme_mod('xstore_waitlist_popup_label_add_to_waitlist', 'Join waiting list'),
            'add_checkbox_text' => get_theme_mod('xstore_waitlist_popup_checkbox_label_add_to_waitlist', 'I consent to being contacted by the store owner'),

            'remove_intro' => get_theme_mod('xstore_waitlist_popup_intro_remove_waitlist', 'Leaving the Waitlist? Confirm Email Removal'),
            'remove_placeholder' => 'Your email address...',
            'remove_button_text' => 'Confirm',
            'remove_checkbox_text' => 'I consent to being contacted by the store owner',
        );
    ...
    public function enqueue_scripts(){
        ...
        wp_localize_script(
            ...
            [
                ...
                'ajax_fragments' => apply_filters('xstore_waitlist_mini_content_ajax', (self::get_products_count()>=1)),
...
//    }
    ...
    public function add_display_post_states($post_states, $post) {
        if ( $post && (int)get_theme_mod('xstore_waitlist_page', '') === $post->ID ) {
...
//                'black'
        ...
        if ( $remove_button_only && !isset($custom_settings['force_display']) ) {
            ...
            if ( apply_filters('xstore_waitlist_product_query_args', true) ) {
            ...
            $attributes_rendered = apply_filters('xstore_waitlist_product_query_atts', $attributes_rendered); ?>
