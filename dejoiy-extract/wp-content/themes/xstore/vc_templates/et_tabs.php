<?php
    ...
    $title_style = isset( $atts['title_style'] ) ? sanitize_html_class( $atts['title_style'] ) : 'default';
    ...
    foreach ( $tab_titles as $tab ) // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited valid use case
    {
      ...
      if ( isset( $tab_atts['title'] ) ) {
        ...
        $tabs_nav .= ( $title_style == 'hover' ) ? '<span class="delimiter"></span>' : '';
      }
    }
    $tabs_nav .= '</ul>';
