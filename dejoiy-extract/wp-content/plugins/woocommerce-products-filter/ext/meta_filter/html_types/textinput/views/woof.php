...
<div data-css-class="woof_textinput_container" class="woof_textinput_container woof_container  woof_container_<?php echo esc_attr( 'textinput_' . $meta_key ); ?> <?php echo esc_attr( WOOF_HELPER::generate_container_css_classes( $meta_key ) ); ?>">
	...
	<div class="woof_container_inner">
		...
		<div class="woof_show_textinput_container ">
			...
			<label class="woof_wcga_label_hide"  for="<?php echo esc_attr( $unique_id ); ?>"><?php echo esc_html( isset( $placeholder ) ? $placeholder : $p ); ?></label>
			<input type="search" class="woof_meta_filter_textinput <?php echo esc_attr( $unique_id ); ?>" id="<?php echo esc_attr( $unique_id ); ?>" data-uid="<?php echo esc_attr( $unique_id ); ?>" data-auto_res_count="<?php echo intval( isset( $auto_res_count ) ? $auto_res_count : 0 ); ?>" data-auto_search_by="<?php echo esc_html( isset( $auto_search_by ) ? $auto_search_by : '' ); ?>" placeholder="<?php echo esc_html( isset( $placeholder ) ? $placeholder : $p ); ?>" name="textinput_<?php echo esc_attr( $meta_key ); ?>" value="<?php echo esc_attr( $woof_text ); ?>" />
		</div>
