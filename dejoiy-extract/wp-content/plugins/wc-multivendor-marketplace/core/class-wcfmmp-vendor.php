        ...
        if (wcfm_is_vendor()) {
            if (WCFMmp_Dependencies::wcfm_plugin_active_check() && WCFM_Dependencies::wcfmu_plugin_active_check()) {
                if (apply_filters('wcfm_is_pref_shipment_tracking', true) && apply_filters('wcfm_is_allow_shipping_tracking', true)) {
                    ...
                    if ($order_sync != 'yes') {
                        $order_vendor_status = apply_filters(
                            'wcfmmp_vendor_order_status',
                            array(
...
?>
        ...
        <div class="wcfm-container">
            <div id="wcfm_vendor_manage_form_store_setting_expander" class="wcfm-content">
                <?php if ($vendor_id != 99999) { ?>
                    ...
                    <?php } ?>
                    <div class="">
                        <h2><?php _e('General Setting', 'wc-multivendor-marketplace'); ?></h2>
                    </div>
                    ...
                    <div class="">
                        <h2><?php _e('Store Brand Setup', 'wc-multivendor-marketplace'); ?></h2>
                    </div>
                    <div class="wcfm_clearfix"></div>
                    ...
                    <?php if (!apply_filters('wcfm_is_pref_multi_store', true)) { ?>
                        ...
                        <div class="wcfm_vendor_settings_heading">
                            <h2><?php _e('Store Address', 'wc-frontend-manager'); ?></h2>
                        </div>
                        <div class="wcfm_clearfix"></div>
                        ...
                        ?>
                            <div class="wcfm_clearfix"></div><br />
                            <div class="wcfm_vendor_settings_heading">
                                <h2><?php _e('Store Location', 'wc-frontend-manager'); ?></h2>
                            </div>
                            <div class="wcfm_clearfix"></div>
                    ...
                    <div class="wcfm_clearfix"></div><br />
                    <div class="wcfm_vendor_settings_heading">
                        <h2><?php _e('Visibility Setup', 'wc-multivendor-marketplace'); ?></h2>
                    </div>
                    <div class="wcfm_clearfix"></div>
        ...
        <div class="wcfm-container">
            <div id="wcfm_vendor_manage_form_store_commission_setting_expander" class="wcfm-content">
                <?php if ($vendor_id != 99999) { ?>
                    ...
                    <div class="wcfm_clearfix"></div>
                    <div class="">
                        <h2><?php _e('Commission Setup', 'wc-frontend-manager'); ?></h2>
                    </div>
                    <div class="wcfm_clearfix"></div><br />
                    ...
                    <div class="wcfm_clearfix"></div><br />
                    <div class="wcfm_vendor_settings_heading">
                        <h2><?php _e('Withdrawal Setup', 'wc-frontend-manager'); ?></h2>
                    </div>
                    <div class="wcfm_clearfix"></div>
                    ...
                    <?php if (in_array('bank_transfer', array_keys($wcfm_marketplace_withdrwal_payment_methods))) { ?>
                        <div class="wcfm_clearfix"></div>
                        <div class="wcfm_marketplace_bank paymode_field paymode_bank_transfer">
    ...
    function wcfmmp_vendor_manage_store_hours_setting($vendor_id) {
        ...
        $wcfm_vacation_mode_msg         = wcfm_get_user_meta($vendor_id, '_wcfm_vacation_msg', true);
            ...
            <div id="wcfm_vendor_manage_form_store_hours_setting_expander" class="wcfm-content">
                <?php if ($vendor_id != 99999) { ?>
                    ...
                    <?php if (WCFMmp_Dependencies::wcfm_plugin_active_check() && WCFM_Dependencies::wcfmu_plugin_active_check()) { ?>
                        <div class="wcfm_clearfix"></div>
                        <div class="wcfm_vendor_settings_heading">
                            <h2><?php _e('Vacation Mode', 'wc-frontend-manager'); ?></h2>
                        </div>
                        <div class="wcfm_clearfix"></div>
            ...
            <div id="wcfm_vendor_manage_form_store_seo_social_setting_expander" class="wcfm-content">
                <?php if ($vendor_id != 99999) { ?>
                    ...
                    <?php if (apply_filters('wcfm_is_allow_store_seo', true)) { ?>
                        <div class="">
                            <h2><?php _e('General Setup', 'wc-frontend-manager'); ?></h2>
                        </div>
                        <div class="wcfm_clearfix"></div>
                        <div class="store_address">
                            <?php
                        ...
                        <?php if (apply_filters('wcfm_is_allow_vendor_seo_facebook', true)) { ?>
                            <div class="wcfm_clearfix"></div><br />
                            <div class="">
                                <h2><?php _e('Facebook Setup', 'wc-frontend-manager'); ?></h2>
                            </div>
                            <div class="wcfm_clearfix"></div>
                            <div class="store_address">
                                <?php
                        ...
                        <?php if (apply_filters('wcfm_is_allow_vendor_seo_twitter', true)) { ?>
                            <div class="wcfm_clearfix"></div><br />
                            <div class="">
                                <h2><?php _e('Twitter Setup', 'wc-frontend-manager'); ?></h2>
                            </div>
                            <div class="wcfm_clearfix"></div>
                            <div class="store_address">
                                <?php
                    ...
                    <?php if (apply_filters('wcfm_is_allow_social_profile', true)) { ?>
                        <div class="wcfm_clearfix"></div>
                        <div class="wcfm_vendor_settings_heading">
                            <h2><?php _e('Social Profile', 'wc-frontend-manager'); ?></h2>
                        </div>
                        <div class="wcfm_clearfix"></div>
            ...
            <div id="wcfm_vendor_manage_form_store_policy_support_setting_expander" class="wcfm-content">
                <?php if ($vendor_id != 99999) { ?>
                    ...
                    <?php if (apply_filters('wcfm_is_allow_customer_support_settings', true)) { ?>
                        <div class="wcfm_clearfix"></div>
                        <div class="wcfm_vendor_settings_heading">
                            <h2><?php _e('Customer Support', 'wc-frontend-manager'); ?></h2>
                        </div>
                        <div class="wcfm_clearfix"></div>
                ...
                <table id="wcfm-orders" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <?php } ?>
                            <?php if ($admin_fee_mode) { ?>
                                <th><?php _e('Fees', 'wc-frontend-manager');
                                    _e(' Amount', 'wc-frontend-manager'); ?></th>
                            <?php } elseif (wcfm_is_vendor()) { ?>
                                <th><?php printf(apply_filters('wcfm_vendors_earned_label', __('Earnings', 'wc-frontend-manager')));
                                    _e(' Amount', 'wc-frontend-manager'); ?></th>
                            <?php } else { ?>
                                <th><?php printf(apply_filters('wcfm_vendors_earned_commission_label', __('Commission', 'wc-frontend-manager')));
                                    _e(' Amount', 'wc-frontend-manager'); ?></th>
                            <?php } ?>
    ...
    function wcfmmp_vendor_profile_complete_percent($user_id) {
        ...
        $profile_complete_percent = count($profile_complete_components) ? 0 : 100;
        $profile_remaining_items = array();


        if (apply_filters('wcfm_is_allow_store_logo', true) && isset($profile_complete_components['gravatar'])) {
            if ($gravatar) {
        ...
        if (apply_filters('wcfm_is_allow_store_name', true) && isset($profile_complete_components['store_name'])) {
            if ($store_name) {
                $profile_complete_percent += $component_percent;
            } else {
        ...
        if (apply_filters('wcfm_is_allow_store_banner', true) && isset($profile_complete_components['banner'])) {
            if ($banner) {
                $profile_complete_percent += $component_percent;
            } else {
        ...
        if (apply_filters('wcfm_is_allow_store_phone', true) && isset($profile_complete_components['phone'])) {
            if ($phone) {
                $profile_complete_percent += $component_percent;
            } else {
        ...
        if (apply_filters('wcfm_is_allow_store_description', true) && isset($profile_complete_components['about'])) {
            if ($shop_description) {
                $profile_complete_percent += $component_percent;
            } else {
                $profile_remaining_items['about'] = __('Add Store Description', 'wc-multivendor-marketplace');
            }
        }

        if (apply_filters('wcfm_is_allow_store_address', true) && isset($profile_complete_components['address'])) {
            if ($street_1 && $country) {
                $profile_complete_percent += $component_percent;
            } else {
            ...
            if (apply_filters('wcfm_is_allow_store_map_location', true) && isset($profile_complete_components['location'])) {
                $api_key = isset($WCFMmp->wcfmmp_marketplace_options['wcfm_google_map_api']) ? $WCFMmp->wcfmmp_marketplace_options['wcfm_google_map_api'] : '';
                $wcfm_map_lib = isset($WCFMmp->wcfmmp_marketplace_options['wcfm_map_lib']) ? $WCFMmp->wcfmmp_marketplace_options['wcfm_map_lib'] : '';
                if (!$wcfm_map_lib && $api_key) {
                    $wcfm_map_lib = 'google';
        ...
        if (apply_filters('wcfm_is_pref_withdrawal', true) && apply_filters('wcfm_is_allow_billing_settings', true) && isset($profile_complete_components['payment'])) {
        ...
        if (apply_filters('wcfm_is_pref_policies', true) && apply_filters('wcfm_is_allow_policy_settings', true) && isset($profile_complete_components['policies'])) {
        ...
        if (apply_filters('wcfm_is_allow_customer_support_settings', true) && apply_filters('wcfm_is_allow_customer_support', true) && isset($profile_complete_components['support'])) {
        ...
        if (apply_filters('wcfm_is_allow_vseo_settings', true) && isset($profile_complete_components['seo'])) {
        ...
        <div class="wcfm-clearfix"></div>
        <div id="wcfmmp_profile_complete_progressbar">
            <div class="wcfmmp_profile_complete_progress_label"><?php esc_html_e('Loading', 'wc-multivendor-marketplace'); ?>...</div>
        </div>
        <?php
...
<?php
    ...
    function wcfmmp_set_location_global_vars($search_data) {
        global $wcfmmp_radius_lat, $wcfmmp_radius_lng, $wcfmmp_radius_range;
        $wcfmmp_radius_lat = '';
        $wcfmmp_radius_lng = '';
        $wcfmmp_radius_range = '';
    ...
    function wcfmmp_get_vendor_list_args($offset = '', $number = '', $search = '', $allow_vendors_list = array(), $order = 'ASC', $orderby = 'login', $search_data = array(), $category = '', $has_product = '') {
        global $wpdb, $wcfmmp_includes_vendors_for_cat_list, $wcfmmp_exclude_vendors_for_cat_list;
        ...
        return apply_filters('wcfmmp_vendor_list_args', $args, $search_data);
    }
    ...
    function wcfmmp_get_vendors($offset = '', $number = '', $search = '', $allow_vendors_list = array(), $order = 'ASC', $orderby = 'login', $search_data = array(), $category = '', $has_product = '') {
        ...
        if (!empty($all_users)) {
            foreach ($all_users as $all_user) {
                $vendor_arr[$all_user->ID][] = array_map('esc_attr', (array) $all_user);
            }
        }
        return apply_filters('wcfmmp_vendors_list', $vendor_arr);
    }
    ...
    public function wcfmmp_best_selling_vendors($limit = 2) {
        ...
        $sql .= " ORDER BY item_total DESC LIMIT %d";
        $vendorwise_sales = $wpdb->get_results($wpdb->prepare($sql, $limit), ARRAY_A);
    ...
    public function wcfmmp_save_vendor_taxonomy($vendor_id, $product_id = 0, $term = 0, $taxonomy = 'product_cat') {
        global $WCFMmp, $wpdb, $WCFM;
    ...
    public function wcfmmp_get_vendor_taxonomy($vendor_id = 0, $taxonomy_type = 'product_cat') {
        ...
        if ($vendor_id) {
            ...
            $wcfmmp_includes_vendors_for_cat_list_placeholders = implode(', ', array_fill(0, count($wcfmmp_includes_vendors_for_cat_list), '%d'));
            $sql .= $wpdb->prepare(" AND `vendor_id` IN ({$wcfmmp_includes_vendors_for_cat_list_placeholders})", $wcfmmp_includes_vendors_for_cat_list);
        } elseif (is_array($wcfmmp_exclude_vendors_for_cat_list) && !empty($wcfmmp_exclude_vendors_for_cat_list)) {
            $wcfmmp_exclude_vendors_for_cat_list_placeholders = implode(', ', array_fill(0, count($wcfmmp_exclude_vendors_for_cat_list), '%d'));
            $sql .= $wpdb->prepare(" AND `vendor_id` NOT IN ({$wcfmmp_exclude_vendors_for_cat_list_placeholders})", $wcfmmp_exclude_vendors_for_cat_list);
        }

        if ($taxonomy_type) {
            $sql .= " AND `taxonomy` = '%s'";
            $sql = $wpdb->prepare($sql, $taxonomy_type);
        }
