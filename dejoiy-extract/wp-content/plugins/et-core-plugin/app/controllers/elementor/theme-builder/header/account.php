                    ...
                    if ( $with_tabs ) :
                        ob_start();
                            woocommerce_login_form(array(
                                'redirect' => $element_page_url,
                                'action' => get_permalink( get_option( 'woocommerce_myaccount_page_id' ) )
                            ));
                        echo str_replace(array('<form', 'woocommerce-form-login '), array('<form data-tab-name="login" autocomplete="off"', 'et_b-tab-content active woocommerce-form-login ' ), ob_get_clean());
                    else:
                        woocommerce_login_form(array(
                            'redirect' => $element_page_url,
                            'action' => get_permalink( get_option( 'woocommerce_myaccount_page_id' ) )
