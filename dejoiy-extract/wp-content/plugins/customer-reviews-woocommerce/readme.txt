...
**CusRev** has two plans: Free and Pro. The Pro plan offers additional features and email support – to find out more and purchase a license, please visit [CusRev’s website](https://www.cusrev.com/business/).
...
= 5.114.0 =
* Improvement: additional security validations of color code parameters in shortcodes and blocks for Trust Badges
* Improvement: include review location in [cusrev_reviews_grid] shortcode
= 5.113.0 =
* Improvement: additional security checks to prevent unauthorized uploads of media files via on-site review forms
= 5.112.0 =
* Bug fix: non-unique table/alias
= 5.111.0 =
* Improvement: additional security checks to prevent unauthorized uploads of media files on local review forms
= 5.110.1 =
* Improvement: CSS improvement for compatibility with third-party themes
= 5.110.0 =
* Improvement: WordPress and WooCommerce compatibility update
* Improvement: additional filters and actions
= 5.109.0 =
* Improvement: prevent upload of media files if 'Attach Images/Videos' setting is disabled
= 5.108.0 =
* New feature: a capability to use a WordPress mailer with the Independently Verified setting
* Improvement: WPML compatibility with review tags in [cusrev_reviews_slider] shortcode
* Improvement: support 'backorder' value for product availability in Google Shopping feed
* Improvement: a new 'cr_gs_product_reviews_feed_data' filter to modify reviews data for Google Shopping feed
* Improvement: a new 'cr_gs_product_feed_availability' filter to modify availability data for products in Google Shopping feed
= 5.107.0 =
* Improvement: support product identifiers created by the Google for WooCommerce plugin
* Bug fix: cross-site scripting vulnerability in submission of reviews
= 5.106.0 =
...
= 5.104.0 =
* Bug fix: vulnerability in the endpoint for submission of reviews
= 5.103.0 =
* Bug fix: incorrect count of reviews on WooCommerce Orders page in certain scenarios
= 5.102.0 =
...
* Improvement: display media files attached to reviews even if upload of new media files is disabled in review forms
= 5.83.4 =
...
= 5.83.2 =
* Improvement: an additional error message when reCAPTCHA is not configured correctly
= 5.83.1 =
* Improved compatibility with LearnDash plugin
= 5.83.0 =
...
= 5.71.0 =
* Improvement: uncouple switching off the Live mode from deactivation of the plugin
* Improvement: check for multibyte string functions
* Improvement: RTL websites compatibility
* Improvement: additional hooks and code optimization
* Minor CSS improvements
= 5.70.0 =
* Improvement: an error message for review reminders that are overdue
* Improvement: enhanced handling of errors related to WP Cron
= 5.69.0 =
...
= 5.65.0 =
* New feature: support of the new 'Global Unique ID' field in WooCommerce products for GTIN, UPC, EAN, or ISBN
* Improvement: replacement of pop-up windows for Q & A with inline forms to improve compatibility with UI of various 3rd-party WordPress themes
= 5.64.1 =
...
* Bug fix: incorrect display of thousands separator for several locales
= 5.62.0 =
