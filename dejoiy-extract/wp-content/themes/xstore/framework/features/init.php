...
* Search page results
* ******************************************************************* */
require_once( apply_filters('etheme_file_url', ETHEME_CODE . 'features/language.php') );

/*
* Pjax
* ******************************************************************* */
if(!get_theme_mod( 'disable_pjax_navigation', false ) ){
	require_once( apply_filters('etheme_file_url', ETHEME_CODE . 'features/pjax/pjax.php') );
}