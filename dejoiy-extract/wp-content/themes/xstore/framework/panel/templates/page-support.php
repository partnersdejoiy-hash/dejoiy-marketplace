...
?>
            ...
            <div class="etheme-videos xstore-panel-grid-wrapper loading">
				...
				if ( ! $videos ) {
					...
					foreach ( $videos as $key => $value ) {
						$i ++;
						$is_hidden_class = ( $i <= 6 ) ? '' : ' hidden';
						?>
                            <div class="xstore-panel-grid-item etheme-video<?php echo esc_attr($is_hidden_class); ?>">
    ...
    <?php
        $global_admin_class->get_additional_panel_blocks(array(
            'vertical_columns' => true,
            'documentation_block' => true,
