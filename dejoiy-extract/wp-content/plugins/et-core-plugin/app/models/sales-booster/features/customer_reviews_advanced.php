...
$global_admin_class->xstore_panel_settings_select_field( $tab_content,
    ...
    (get_option( 'etheme_single_product_builder', false ) ? sprintf(
        ...
        '<a href="'.apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=product_tabs'), 'product_tabs').'" target="_blank" rel="nofollow">'.esc_html__('Separated Reviews', 'xstore-core').'</a>'
