...
<div class="et_popup-theme-registration et_panel-popup-inner with-scroll">
    ...
    <div class="steps-block-content">
        <div class="popup-step step-1">
            ...
            $domains = et_get_domain_tokens($_POST['code']);
            $block_liv = $block_dev = false;

            // var_dump($domains);

            if(is_array($domains) && isset($domains['domains'])){
                if(isset($domains['domains']['live']) && count($domains['domains']['live']) > 0){
                    $block_liv = true;
                }

                if(isset($domains['domains']['staging']) && count($domains['domains']['staging']) > 0){
                    $block_dev = true;
                }
            }
            
            // var_dump($domains['domains']["live"]);
...
<!--				--><?php //echo 'When choosing how to use this <b>['.$domain.']</b> domain, it\'s essential to consider your specific objectives:'; ?>
                ...
                <?php echo esc_html__('When choosing how to use this', 'xstore') ?> <b>[<?php echo $domain; ?>]</b> <?php echo esc_html__('domain, it\'s important to think about your specific goals:', 'xstore') ?>
            </p>
            ...
            <div class="domain-selectors">
                <div class="mtips">
                    <?php if($block_liv): ?>
                        <span class="mt-mes">
                            <?php echo esc_html__('You have already activated your license', 'xstore') ?>
                            <br>
                            <?php echo esc_html__('for this slot.', 'xstore') ?>
                        </span>    
                    <?php endif; ?> 
                    <div class="domain-selector <?php echo ($block_liv) ? 'blocked' : ''; ?> <?php echo ($block_dev) ? " active": ""; ?>">
                    <h4>
                            <input type="radio" id="et_register_domain_type_live" name="domain_type" value="live" <?php echo ($block_dev) ? "checked": ""; ?>  />
                ...
                <div class="mtips">
                    ...
                    <?php endif; ?>
                    <div class="domain-selector <?php echo ($block_dev) ? 'blocked' : ''; ?><?php echo ($block_liv) ? " active": ""; ?>">
                    <h4>
                            <input type="radio" id="et_register_domain_type_staging" name="domain_type" value="staging" <?php echo ($block_liv) ? "checked": ""; ?>  />
                            <label for="et_register_domain_type_staging"><?php echo esc_html__('Staging Website 1(SITE)', 'xstore'); ?></label>
                        </h4>
        ...
        <div class="popup-step step-2 hidden">
            <h3><?php echo esc_html__('Registration Guidelines', 'xstore'); ?></h3>
            ...
            <div class="section-block step-1">
                ...
                <p class="section-text">
                    ...
                    <?php echo sprintf(__('<b>License & Data Policy:</b> By clicking "Register", I confirm that I have read and agree to the %s (1 live + 1 staging domain per license), and I allow %s to securely store my purchase code and user data for license management. I understand I can manage or remove active domains anytime via my account on %s.', 'xstore'), '<a href="https://themeforest.net/licenses/terms/regular" target="_blank">'.esc_html__('ThemeForest license policy', 'xstore').'</a>', '<a href="https://www.8theme.com/" target="_blank">8theme.com</a>', '<a href="https://www.8theme.com/account/" target="_blank">8theme.com</a>'); ?>
                </p>
            </div>
...
<!--            </div>-->
        ...
        <div class="popup-step step-3 invisible hidden">
            ...
            <br/><br/>
            <h3><?php echo esc_html__('Theme Successfully Activated!', 'xstore'); ?></h3>
            <p>
				<?php echo esc_html__('Your license has been successfully verified, and the theme is now activated. Auto updates are enabled. We\'re excited to support your web development journey and help you build amazing experiences.', 'xstore'); ?>
            </p>
            <p><?php echo esc_html__('Happy building!', 'xstore'); ?></p>
            <br/>
...
<div class="mtips mtips-top">
                    <span class="et-button et-button-arrow full-width no-loader tooltip-trigger popup-domain-confirm <?php echo ($block_dev || $block_liv) ? 'enabled' : '';?>">
...
<div class="mtips mtips-top">
                    <span class="et-button full-width no-loader tooltip-trigger popup-theme-register hidden">
                        <?php echo esc_html__('Activate Theme', 'xstore'); ?>
                    </span>
    <span class="mt-mes"><?php echo esc_html__('Please confirm all steps and important guidelines before proceeding.', 'xstore'); ?></span>
</div>
<a href="<?php echo admin_url( 'admin.php?page=et-panel-welcome&section-focus=licence-form' ); ?>" class="et-button et-button-arrow full-width no-loader tooltip-trigger popup-go-to-import hidden enabled"><?php echo esc_html__('Go To Dashboard', 'xstore'); ?>
    <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 32 32">
        <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-miterlimit="10">
            <circle class="arrow-icon--circle" cx="16" cy="16" r="15.12"></circle>
            <path class="arrow-icon--arrow" d="M16.14 9.93L22.21 16l-6.07 6.07M8.23 16h13.98"></path>
