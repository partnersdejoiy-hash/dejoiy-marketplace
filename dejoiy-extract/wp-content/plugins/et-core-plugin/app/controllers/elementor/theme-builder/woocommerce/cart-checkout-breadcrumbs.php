...
class Cart_Checkout_Breadcrumbs extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return apply_filters('etheme_elementor_widget_style_depends', [ 'etheme-elementor-breadcrumbs-steps' ]);
    }
    ...
    public function get_script_depends() {
        return apply_filters('etheme_elementor_widget_script_depends', ['etheme_elementor_breadcrumbs_steps']);
    }
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => sprintf(esc_html__('To set up breadcrumbs for Cart/Checkout pages, you can use a %s or employ the "WooCommerce Breadcrumbs" widget.', 'xstore-core'),
                    '<a href="'.apply_filters('etheme_theme_options_permalink', admin_url('/customize.php?autofocus[section]=breadcrumbs'), 'breadcrumbs').'" target="_blank">'.esc_html__('Special breadcrumb on the cart, checkout, and order pages.', 'xstore-core') . '</a>'). '<br/>' .
