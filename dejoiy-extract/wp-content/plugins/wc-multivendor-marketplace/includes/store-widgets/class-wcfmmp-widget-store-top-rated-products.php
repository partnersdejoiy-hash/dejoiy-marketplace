...
class WCFMmp_Store_Top_Rated_Products extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 'classname' => 'wcfmmp-store-top-rated-products', 'description' => __( 'Store Top Rated Products', 'wc-multivendor-marketplace' ) );
		parent::__construct( 'wcfmmp-store-top-rated-products', __( 'Vendor Store: Top Rated Products', 'wc-multivendor-marketplace' ), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( $products && $products->have_posts() ) {
			...
			$template_args = array(
				'widget_id'   => isset( $args['widget_id'] ) ? $args['widget_id'] : 'wcfmmp-store-top-rated-products-'.rand(10,100),
				'show_rating' => true,
			);
	...
	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array(
				'title'     => __( 'Top Rated Products', 'wc-multivendor-marketplace' ),
				'number'    => 5,
				'hide_free' => '',
		) );
