 ...
 */
class Posts_Timeline extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Posts Timeline', 'xstore-core' );
	}
	...
	public function get_icon() {
		return 'eight_theme-elementor-icon et-elementor-posts-timeline';
	}
	...
	public function get_keywords() {
		return [ 'timeline', 'progress', 'step', 'date', 'post', 'query', 'post type', 'grid', 'blog', 'layout' ];
	}
	...
	public function get_script_depends() {
        return apply_filters('etheme_elementor_widget_script_depends', ['etheme_vertical_timeline']);
	}
	...
	public function get_style_depends() {
	    return apply_filters('etheme_elementor_widget_style_depends', ['etheme-elementor-vertical-timeline', 'etheme-elementor-posts']);
	}
...
//		$this->end_controls_section();
		...
		$this->register_data_time_style_controls();
...
//					'inside'		=>	esc_html__('Inside', 'xstore-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' 			=>	\Elementor\Controls_Manager::SELECT,
                'options' 		=>	[
                    'date_time'	=>	esc_html__('Date + Time', 'xstore-core'),
                    'date'	=>	esc_html__('Date', 'xstore-core'),
                    'time'	=>	esc_html__('Time', 'xstore-core'),
                ],
                'default'		=> 'date',
                'conditions' => [
                    'relation' => 'or',
...
//					);
                ...
                case 'meta':
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => [ 'author', 'comments', 'share' ],
                            'multiple' => true,
                            'options' => self::get_post_meta_data_elements(),
                            'separator' => 'before',
                            'condition' => [
                                'post_'.$key.'!' => '',
                            ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => ( $specific_source_key == 'current_query' ?
                        sprintf(esc_html__('Note: The %s is available when creating a Post Archive template. It will not work on non-posts archive pages like Home, About Us, Contact us etc.', 'xstore-core'), $specific_source_title) :
                        sprintf(esc_html__('Note: The %s Query is available when creating a Single Post template', 'xstore-core'), $specific_source_title) ),
                    'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                    'condition' => [
    ...
    protected function register_data_time_style_controls() {
        $this->start_controls_section(
            'section_data_time_style',
            [
                'label' => __( 'Date/Time', 'xstore-core' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'conditions' => [
...
//		);
        ...
        $this->add_group_control(
            ...
            [
                'label' => __('Date Typography', 'xstore-core'),
                'name' => 'date_typography',
                'selector' => '{{WRAPPER}} .etheme-timeline-date',
                'condition' => [
                    'date_time_content!' => 'time'
                ]
            ]
        );
        ...
        $this->add_control(
            'date_color',
            [
                'label' => __( 'Date Color', 'xstore-core' ),
        ...
        $this->add_control(
            'date_space',
            [
                'label' => __( 'Date Space', 'xstore-core' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
                ...
                'condition' => [
                    'date_time_content' => 'date_time'
                ]
            ]
        );

        $this->add_control(
            'date_time_style_divider',
            [
                'type' => \Elementor\Controls_Manager::DIVIDER,
                'condition' => [
                    'date_time_content' => 'date_time'
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'label' => __('Time Typography', 'xstore-core'),
                'name' => 'time_typography',
                'selector' => '{{WRAPPER}} .etheme-timeline-time',
                'condition' => [
                    'date_time_content!' => 'date'
                ]
            ]
        );
        ...
        $this->add_control(
            'time_color',
            [
                'label' => __( 'Time Color', 'xstore-core' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'time_space',
            [
                'label' => __( 'Time Space', 'xstore-core' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etheme-timeline-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
...
//				],
    ...
    protected function register_connector_style_controls() {
        $this->start_controls_section(
	...
	protected function render() {
        ...
        self::$widget_type = 'posts-timeline';
		...
		if ( $settings['image_position'] != 'top' ) {
			$this->add_render_attribute( 'items-wrapper', [
				'class' => [
		...
		if ( $posts && $posts->have_posts() ) {
            ...
            <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
                ...
                <div <?php $this->print_render_attribute_string( 'items-wrapper' ); ?>>
                    <?php
                        while ( $posts->have_posts() ) {
                            $posts->the_post();
                            $this->get_content_post_wrapper($local_settings, $migration_allowed);
                        }
                    ?>
                ...
                <?php if ( $settings['date_position'] == 'outside' ) { ?>
                    ...
                    <div <?php $this->print_render_attribute_string( 'dates-items-wrapper' ); ?>>
                        <?php $this->render_data_time(false, true, self::$local_date); ?>
                    </div>
            ...
            if ( $settings['navigation'] != 'none' ) {
                ...
                if ( $posts->max_num_pages > 1 && ($settings['limit'] == -1 || $settings['limit'] > $settings['posts_per_page']) ) {
                    ...
                    $button_attributes = 'load-more-button';
...
//                                $post_content[$key.'_shape_divider_bottom_negative'] = $settings[$key.'_shape_divider_bottom_negative'];
                    ...
                    $post_content['layout'] = $settings['layout'];
                    $post_content['date_time_content'] = $settings['date_time_content'];
                    $post_content['item_arrow'] = $settings['item_arrow'];
                    $post_content['icon_position'] = $settings['icon_position'];
    ...
    // Posts functions
    public function get_content_post_wrapper($settings, $migration_allowed) {
        ...
        switch ($settings['date_time_content']) {
            case 'date':
                unset($data_time['time']);
                break;
            case 'time':
                unset($data_time['date']);
                break;
            default;
        }

        self::$local_date[] = $data_time;
...
//                            $this->add_link_attributes( 'button_text', $tab['link'] );
//                        } ?>
        ...
        <div <?php $this->print_render_attribute_string( 'item-wrapper'.$tab['_id'] ); ?>>
            ...
            if ( $settings['icon_position'] != 'step' )
                ...
                $this->render_icon($settings, $settings, $migration_allowed, true);
            ?>

            <?php
            if ( $settings['layout'] == 'center' ) {
                $this->render_data_time($data_time, true);
                ?>
            <?php } ?>
            ...
            <div <?php $this->print_render_attribute_string( 'item-content'.$tab['_id'] ); ?>>
                ...
                <div class="etheme-timeline-content-inner">
                    ...
                    <?php $this->get_content_post($settings); ?>
...
<path d="M22.56 1.68h-2.568v-1.032c0-0.264-0.24-0.576-0.576-0.576h-2.76c-0.264 0-0.576 0.24-0.576 0.576v1.032h-8.28v-1.032c0-0.264-0.24-0.576-0.576-0.576h-2.712c-0.264 0-0.576 0.24-0.576 0.576v1.032h-2.496c-0.264 0-0.552 0.24-0.552 0.576v21.096c0 0.264 0.24 0.576 0.576 0.576h21.096c0.264 0 0.576-0.24 0.576-0.576v-21.12c-0.024-0.312-0.264-0.552-0.576-0.552zM22.032 7.080v15.72h-20.016v-15.72h20.016zM5.136 3.24v-2.040h1.632v2.064h-1.632zM17.232 3.24v-2.040h1.632v2.064h-1.632zM4.608 4.392h2.76c0.264 0 0.576-0.24 0.576-0.576v-1.032h8.256v1.032c0 0.264 0.24 0.576 0.576 0.576h2.736c0.264 0 0.576-0.24 0.576-0.576v-1.032h1.992v3.216h-20.064v-3.216h2.040v1.032c-0.024 0.264 0.216 0.576 0.552 0.576zM19.584 9.096h-15.168v11.664h15.192v-11.664zM18.48 17.232v2.424h-2.424v-2.424h2.424zM18.48 13.704v2.448h-2.424v-2.448h2.424zM18.48 10.176v2.448h-2.424v-2.448h2.424zM14.976 17.232v2.424h-2.4v-2.424h2.4zM14.976 13.704v2.448h-2.4v-2.448h2.4zM14.976 10.176v2.448h-2.4v-2.448h2.4zM9.024 12.624v-2.448h2.424v2.448h-2.424zM9.024 16.152v-2.448h2.424v2.448h-2.424zM11.448 17.232v2.424h-2.424v-2.424h2.424zM7.92 17.232v2.424h-2.424v-2.424h2.424zM7.944 13.704v2.448h-2.424v-2.448h2.424zM7.944 10.176v2.448h-2.424v-2.448h2.424z"></path>
	...
	protected function render_post_read_more() {
		global $local_settings;
		?>
        <a class="etheme-timeline-button <?php echo ('button' == $local_settings['post_button_type'] ? 'elementor-button ' : ''); ?>etheme-post-button" href="<?php echo get_permalink(get_the_ID()); ?>">
			<?php
