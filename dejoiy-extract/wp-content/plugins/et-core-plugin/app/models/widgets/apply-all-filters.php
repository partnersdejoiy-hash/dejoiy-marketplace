...
class Apply_All_Filters extends Widgets {
	...
	function widget($args, $instance) {
		...
		wp_register_script( 'et_apply_filters', get_template_directory_uri() . '/js/modules/apply-filters.min.js',array(apply_filters('etheme_elementor_force_localize_global_assets', 'etheme',  'general')), '1.0.0', true );
